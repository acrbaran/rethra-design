...
// (the registry only resolves SKILL.md / .claude-plugin / rethra-design.json
...
export async function runExampleGenerator(opts: ExampleGeneratorOptions): Promise<RunStats> {
  ...
  for (const id of slice) {
    ...
    const manifest = buildManifest({
      ...
      homepage: `https://github.com/acrbaran/rethra-design/tree/main/plugins/_official/${TIER_EXAMPLES}/${id}`,
      tags: dedupeTags([
        'example',
        'first-party',
        mode,
