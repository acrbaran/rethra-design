...
## Rethra Design orchestration mode

When this skill is invoked inside Rethra Design, treat it as the design-flow
...
3. Search across every available Rethra Design resource, not only this skill:
