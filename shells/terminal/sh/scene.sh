...
mkdir -p "$stage/carrier" "$stage/runtime/standalone" \
  "$stage/runtime/node_modules/@rethra-design/sidecar/dist" \
  "$stage/runtime/node_modules/@rethra-design/platform/dist" \
...
cp "$sidecar_directory/index.mjs" "$sidecar_directory/supervisor.mjs" "$stage/runtime/node_modules/@rethra-design/sidecar/dist/"
cp "$platform_directory/index.mjs" "$stage/runtime/node_modules/@rethra-design/platform/dist/index.mjs"
printf '%s\n' '{"name":"@rethra-design/sidecar","type":"module","exports":{".":"./dist/index.mjs"}}' > "$stage/runtime/node_modules/@rethra-design/sidecar/package.json"
printf '%s\n' '{"name":"@rethra-design/platform","type":"module","exports":{".":"./dist/index.mjs"}}' > "$stage/runtime/node_modules/@rethra-design/platform/package.json"
...
for module_file in \
  ...
  runtime/node_modules/@rethra-design/sidecar/package.json; do
