...
export class FixtureShellUpdaterPort implements StandaloneShellUpdaterPort {
  ...
  constructor(root: string, scope: LifecycleScope, lifecycle: LifecyclePort & StandaloneLifecycleTransitionPort, options?: {
    algebra: typeof import("@rethra-design/standalone").SHELL_UPDATE_ALGEBRA;
    attachmentId?: string;
    ...
    withRetiredStandalone?: <T>(input: Readonly<{
      ...
      attemptId: string;
      fence: number;
      occupants: readonly import("@rethra-design/standalone").StandaloneLifecycleOccupant[];
    }>, commit: () => Promise<T>) => Promise<T>;
    shellType?: string;
    standalone?: typeof import("@rethra-design/standalone");
    target?: string;
    trustedKeys?: import("@rethra-design/standalone").StandaloneTrustedKeyRing;
  });
