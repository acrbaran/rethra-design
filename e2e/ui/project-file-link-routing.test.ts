...
async function seedProjectWithAssistantFileLink(
  ...
  const localAbsoluteHref = `/Users/mac/rethra-design/rethra-design-preview-0.10.0/projects/File%20Link%20Routing/index.html`;
...
async function waitForWorkspaceReady(page: Page) {
  await page.getByText('Loading RethraDesign…').waitFor({ state: 'hidden', timeout: T.medium }).catch(() => {});
