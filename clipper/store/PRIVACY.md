# Rethra Design Web Clipper — Privacy Policy

_Last updated: 2026-06-16_

**Short version: the Rethra Design Web Clipper does not collect, store, or transmit
your data to us or to any third party. Everything you clip goes only to the
Rethra Design app running on your own computer.**
...
viewing and sends it to the Rethra Design application running locally on your own
...
Nothing. The developer (Rethra Design / nexu-io) operates **no servers** that
...
- **Access to websites you clip (`<all_urls>`)** — to read and screenshot the
  ...
  reach your local Rethra Design app. The extension acts only on the page you
...
- **Context menus** — the right-click "Save image to Rethra Design Library" entry.
...
All captured content is stored by the Rethra Design app in its local Library on your
...
Questions: https://github.com/acrbaran/rethra-design/issues
