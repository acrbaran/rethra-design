// RethraDesign Web Clipper i18n runtime.
//
...
(function () {
  ...
  const en = {
    extensionName: 'RethraDesign Web Clipper',
    extensionDescription: 'Clip pages, design systems, screenshots, images, and Figma import JSON into your RethraDesign Library.',
    webClipper: 'Web Clipper',
    rethraDesign: 'RethraDesign',
    ...
    hintHtml: '<strong>RethraDesign</strong> is not running. Start the app, then reopen this popup - the clipper connects automatically.',
    advanced: 'Advanced',
    ...
    refreshPageTitle: 'Reload this page so RethraDesign can attach',
    ...
    rethraDesignNotRunning: 'RethraDesign is not running - start the app first.',
    savedConnected: 'Saved - connected.',
    savedNotDetected: 'Saved, but RethraDesign was not detected at that URL.',
    ...
    odNotAttached: 'RethraDesign has not attached to this page yet.',
    ...
    toolbarDragLabel: 'Drag the RethraDesign bar',
    toolbarHomeTip: 'RethraDesign - rethra-design.invalid',
    toolbarHomeLabel: 'RethraDesign home',
    ...
    toolbarHide: 'Hide RethraDesign bar',
    rethraDesignStartApp: 'RethraDesign is not running - start the app',
    ...
    saveImageToLibrary: 'Save image to RethraDesign Library',
    saveImageToRethraDesign: 'Save image to RethraDesign',
  ...
  const overrides = {
    id: {
      extensionDescription: 'Klip halaman, sistem desain, tangkapan layar, gambar, dan JSON impor Figma ke Library RethraDesign.',
    ...
    de: {
      extensionDescription: 'Sammle Seiten, Designsysteme, Screenshots, Bilder und Figma-Import-JSON in deiner RethraDesign Library.',
    ...
    'zh-CN': {
      extensionName: 'RethraDesign 网页剪藏',
      extensionDescription: '将网页、设计系统、截图、图片和 Figma 导入 JSON 剪藏到 RethraDesign 素材库。',
      ...
      hintHtml: '<strong>RethraDesign</strong> 未运行。启动应用后重新打开此弹窗，插件会自动连接。',
      ...
      daemonUrl: 'Daemon 地址', save: '保存', refreshPage: '刷新页面', refreshPageTitle: '刷新此页面以便 RethraDesign 挂载',
      toggleOnPageBar: '切换页面浮条', toggleImageHover: '切换图片悬浮捕获按钮',
      rethraDesignNotRunning: 'RethraDesign 未运行，请先启动应用。', savedConnected: '已保存，已连接。',
      savedNotDetected: '已保存，但该地址未检测到 RethraDesign。', capturingPage: '正在捕获页面...',
      ...
      odNotAttached: 'RethraDesign 尚未挂载到此页面。', elementPickerUnavailable: '此页面不可使用元素选择器，请尝试普通网站。',
      ...
      toolbarDrag: '拖动移动', toolbarDragLabel: '拖动 RethraDesign 浮条', toolbarCapturePage: '捕获页面 -> 素材库',
      ...
      toolbarHide: '隐藏 RethraDesign 浮条', rethraDesignStartApp: 'RethraDesign 未运行，请启动应用',
      ...
      saveImageToLibrary: '保存图片到 RethraDesign 素材库', saveImageToRethraDesign: '保存图片到 RethraDesign',
    ...
    'zh-TW': {
      extensionName: 'RethraDesign 網頁剪藏',
      extensionDescription: '將網頁、設計系統、截圖、圖片和 Figma 匯入 JSON 剪藏到 RethraDesign 素材庫。',
    ...
    'pt-BR': {
      extensionDescription: 'Capture páginas, kits de marca, screenshots, imagens e JSON de importação do Figma na sua Library RethraDesign.',
    ...
    'es-ES': {
      extensionDescription: 'Guarda páginas, kits de marca, capturas, imágenes y JSON de importación de Figma en tu Library de RethraDesign.',
    ...
    ru: {
      extensionDescription: 'Сохраняйте страницы, дизайн-системы, скриншоты, изображения и Figma import JSON в библиотеку RethraDesign.',
    ...
    fa: {
      extensionDescription: 'صفحه‌ها، سیستم‌های طراحی، اسکرین‌شات‌ها، تصاویر و JSON واردسازی Figma را در کتابخانه RethraDesign ذخیره کنید.',
    ...
    ar: {
      extensionDescription: 'احفظ الصفحات وأنظمة التصميم ولقطات الشاشة والصور وملف Figma JSON في مكتبة RethraDesign.',
    ...
    ja: {
      extensionDescription: 'ページ、デザインシステム、スクリーンショット、画像、Figma インポート JSON を RethraDesign Library に保存します。',
    ...
    ko: {
      extensionDescription: '페이지, 디자인 시스템, 스크린샷, 이미지, Figma 가져오기 JSON을 RethraDesign Library에 저장합니다.',
    ...
    pl: {
      extensionDescription: 'Zapisuj strony, systemy projektowe, zrzuty ekranu, obrazy i JSON importu Figma w bibliotece RethraDesign.',
    ...
    hu: {
      extensionDescription: 'Oldalak, designrendszerek, képernyőképek, képek és Figma import JSON mentése az RethraDesign Librarybe.',
    ...
    fr: {
      extensionDescription: 'Capturez pages, systèmes de design, captures, images et JSON import Figma dans votre Library RethraDesign.',
    ...
    uk: {
      extensionDescription: 'Зберігайте сторінки, дизайн-системи, скриншоти, зображення та Figma import JSON у бібліотеку RethraDesign.',
    ...
    tr: {
      extensionDescription: 'Sayfaları, tasarım sistemlerini, ekran görüntülerini, görselleri ve Figma içe aktarma JSONunu RethraDesign Libraryye kaydedin.',
    ...
    th: {
      extensionDescription: 'บันทึกหน้าเว็บ ระบบดีไซน์ ภาพหน้าจอ รูปภาพ และ Figma import JSON ไปยัง RethraDesign Library',
    ...
    it: {
      extensionDescription: 'Salva pagine, design system, screenshot, immagini e JSON di importazione Figma nella Library RethraDesign.',
    ...
    vi: {
      extensionDescription: 'Lưu trang, hệ thống thiết kế, ảnh chụp màn hình, hình ảnh và JSON nhập Figma vào RethraDesign Library.',
    ...
    nl: {
      extensionDescription: 'Sla pagina’s, designsystemen, screenshots, afbeeldingen en Figma-import-JSON op in je RethraDesign Library.',
