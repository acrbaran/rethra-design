...
- The repository prefers package-scoped validation, including `pnpm --filter @rethra-design/web test`. Source: `AGENTS.md#Common commands`.
...
- Run `pnpm --filter @rethra-design/web test` after adding the test. Source: `AGENTS.md#Common commands`.
...
- Passed: `pnpm --filter @rethra-design/web test -- tests/components/assistant-message-tool-status.test.tsx tests/runtime/tool-renderers.test.tsx` (`84` files, `751` tests).
- Passed: `pnpm --filter @rethra-design/web typecheck`.
