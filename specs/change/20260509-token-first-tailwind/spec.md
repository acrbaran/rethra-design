...
- Scope: `apps/web` style toolchain. Impact: add Tailwind v4/PostCSS dependencies and config at the web package boundary because `@rethra-design/web` owns `dev/build/typecheck/test` scripts and currently declares no Tailwind/PostCSS dependencies. Source: `apps/web/package.json:23-50`; `https://tailwindcss.com/docs/guides/nextjs`
...
- Scope: testing and validation. Impact: web-owned tests live in `apps/web/tests/`; validate through `pnpm guard`, `pnpm typecheck`, `pnpm --filter @rethra-design/web test`, and `pnpm --filter @rethra-design/web build`. Source: `apps/AGENTS.md:19-24,39-51`; `AGENTS.md#Validation strategy`
...
- Decision: clear Tailwind's default color namespace with `--color-*: initial` before declaring project colors, so project classes express the Rethra Design token set. Source: `https://tailwindcss.com/docs/customizing-colors`; `apps/web/src/index.css:6-49`
...
- Toolchain: run `pnpm install`, then `pnpm --filter @rethra-design/web build`, proving the Next/Tailwind/PostCSS integration compiles. Source: `apps/web/package.json:23-29`; `AGENTS.md#Validation strategy`
- Type safety: after config and TS guard changes, run `pnpm typecheck` and `pnpm --filter @rethra-design/web typecheck`. Source: `AGENTS.md#Validation strategy`; `apps/AGENTS.md:39-51`
...
Goal: add Tailwind v4 infrastructure, expose Rethra Design tokens as Tailwind utilities, and land the first style guard scaffolding.
...
- [x] Step 1: Install Tailwind foundations
  ...
  - [x] Substep 1.7 Verify: Run `pnpm --filter @rethra-design/web build`.
- [x] Step 2: Expose Rethra Design tokens as Tailwind utilities
  ...
  - [x] Substep 2.5 Verify: Run `pnpm --filter @rethra-design/web build`.
- [x] Step 3: Add base style guardrails
  ...
  - [x] Substep 3.8 Verify: Run `pnpm --filter @rethra-design/web test`.
- [x] Step 4: Build migration inventory and agent visual comparison prep
  ...
  - [x] Substep 4.6 Verify: Run `pnpm guard`, `pnpm typecheck`, `pnpm --filter @rethra-design/web test`, and `pnpm --filter @rethra-design/web build`.
...
- [ ] Step 6: Migrate shell and common controls
  ...
  - [ ] Substep 6.6 Verify: Run `pnpm guard`, `pnpm typecheck`, `pnpm --filter @rethra-design/web test`, and `pnpm --filter @rethra-design/web build`.
...
- [ ] Step 8: Migrate settings and project panel areas
  ...
  - [ ] Substep 8.6 Verify: Run `pnpm guard`, `pnpm typecheck`, `pnpm --filter @rethra-design/web test`, and `pnpm --filter @rethra-design/web build`.
...
- [ ] Step 10: Migrate file viewer and inspect/edit-mode overlays
  ...
  - [ ] Substep 10.6 Verify: Run `pnpm guard`, `pnpm typecheck`, `pnpm --filter @rethra-design/web test`, and `pnpm --filter @rethra-design/web build`.
...
- [ ] Step 12: Migrate sketch and runtime content boundaries
  ...
  - [ ] Substep 12.7 Verify: Run `pnpm guard`, `pnpm typecheck`, `pnpm --filter @rethra-design/web test`, and `pnpm --filter @rethra-design/web build`.
...
- [ ] Step 14: Final cleanup and strict enforcement
  ...
  - [ ] Substep 14.7 Verify: Run `pnpm --filter @rethra-design/web test`.
  - [ ] Substep 14.8 Verify: Run `pnpm --filter @rethra-design/web build`.
