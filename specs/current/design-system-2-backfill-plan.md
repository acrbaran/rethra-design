...
Rethra Design now has two related but different design-system states:
...
This is not a claim that Rethra Design has re-crawled every original upstream
brand repository. For bundled systems, provenance should be explicit: the
derived package is based on the curated Rethra Design design-system fixture. That
