...
- **Path:** `skills/editorial-collage/` → `design-templates/rethra-design-landing/`.
- **Shared assets:** downstream paths such as `../editorial-collage/assets/`
  (for example from the slide-deck template) should use
  [`../rethra-design-landing/assets/`](./assets/) — see
  [`rethra-design-landing-deck`](../rethra-design-landing-deck/README.md).

## See also

- [`design-systems/atelier-zero/DESIGN.md`](../../design-systems/atelier-zero/DESIGN.md) — colors, type, motion tokens.
- [`design-templates/rethra-design-landing-deck/`](../rethra-design-landing-deck/) — sibling template that produces a slide deck in the same visual language.
