...
description: >
  ...
  collage) — the same aesthetic Rethra Design uses for its own marketing
...
sibling [`rethra-design-landing-deck`](../rethra-design-landing-deck/) skill)
...
This is the canonical Rethra Design marketing-page recipe — the example
output is the very page you see at [rethra-design](https://github.com/acrbaran/rethra-design).
...
worked example (Rethra Design itself).
...
└── assets/
    ├── *.png                # 16 collage plates (Rethra Design instance)
...
- [`design-templates/rethra-design-landing-deck/`](../rethra-design-landing-deck/) — sibling slides skill that reuses this design system.
