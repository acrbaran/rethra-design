/**
 * rethra-design-landing-deck — input schema.
 *
 * Sister skill to `rethra-design-landing`. Produces a single-file slide
...
import type { MixedText, BrandBlock, ImageryConfig } from '../rethra-design-landing/schema';
...
export interface CoverSlide {
  kind: 'cover';
  /** Eyebrow above the title — `'RethraDesign · Vol. 01'`. */
  eyebrow: string;
...
export interface RethraDesignLandingDeckInputs {
  $schema?: string;
  brand: BrandBlock;
  /** Deck-wide title shown in the HUD — `'RethraDesign · Vol. 01'`. */
  deck_title: string;
  slides: Slide[];
...
/**
 * @deprecated Use `RethraDesignLandingDeckInputs`.
 *
 ...
 */
export type EditorialCollageDeckInputs = RethraDesignLandingDeckInputs;
