---
name: rethra-design-landing-deck
en_name: "Write a Brand-Story Deck like a Founder Storyteller"
zh_name: "像会讲故事的创始人一样写品牌故事稿"
description: |
  Rethra Design's brand-story deck for partners and press: why it exists, what it believes, and where design is going. Built as a decision-grade marketing & GTM deck for partners, press, community.
en_description: |
  Rethra Design's brand-story deck for partners and press: why it exists, what it believes, and where design is going. Built as a decision-grade marketing & GTM deck for partners, press, community.
zh_description: |
...
od:
  ...
  scenario: "marketing"
  example_prompt: "Create \"Write a Brand-Story Deck like a Founder Storyteller\" as a decision-grade Marketing & GTM deck in this template's own visual system. Subject: Rethra Design's brand-story deck for partners and press: why it exists, what it believes, and where design is going. Audience: partners, press, community. First ask only for missing essentials: audience, decision target, source-of-truth materials, deadline, and must-keep numbers. Then produce the slide plan, written slides, visual direction, speaker-ready structure, and a critic pass against this rubric: can the plan connect creative choices to measurable growth."
inputs:
  - id: brand
  ...
  - id: deck_title
    ...
    description: e.g. `'Rethra Design · Vol. 01 / Issue Nº 26'`.
  - id: slides
  ...
  - id: imagery
    ...
    schema_path: ../rethra-design-landing/schema.ts#ImageryConfig
parameters:
...
example_prompt: |
  ...
  card. Reuse the rethra-design-landing image library.
---

# rethra-design-landing-deck

Sister skill to [`rethra-design-landing`](../rethra-design-landing/). Same
...
```text
inputs.json + ../rethra-design-landing/styles.css
        │
        └──────────► scripts/compose.ts
                            │
                            ▼
...
`rethra-design-landing` brief, copy `brand` and `imagery` over verbatim.
...
script — it shares the 16-slot library from `rethra-design-landing`. To
regenerate or stub:

```bash
# generate via gpt-image-2 (fal.ai)
FAL_KEY=... npx tsx ../rethra-design-landing/scripts/imagegen.ts ../rethra-design-landing/inputs.example.json --out=../rethra-design-landing/assets/

# or paper-textured SVG placeholders
npx tsx ../rethra-design-landing/scripts/placeholder.ts ../rethra-design-landing/assets/
```

Set your deck's `inputs.imagery.assets_path` to wherever those PNGs
live (default in the example: `../rethra-design-landing/assets/`).
...
stylesheet from `../rethra-design-landing/styles.css`, layers
...
- **Reuse the sister skill's stylesheet.** The composer reads
  `../rethra-design-landing/styles.css` at compile time. Do not
...
- [`rethra-design-landing`](../rethra-design-landing/) — landing page sister skill.
