...
/**
 * rethra-design-landing-deck — slide deck composer.
 *
 ...
 * stylesheet from the sister `rethra-design-landing` skill, then layers
...
const SISTER_STYLES = resolve(SKILL_ROOT, '..', 'rethra-design-landing', 'styles.css');
...
/* ------------------------------------------------------------------ *
 * deck-specific stylesheet (layered on top of rethra-design-landing CSS).
 *
...
function chromeStrip(brand: RethraDesignLandingDeckInputs['brand'], deckTitle: string): string {
...
function footStrip(idx: number, total: number, brand: RethraDesignLandingDeckInputs['brand']): string {
...
function renderSlide(
  ...
  i: number,
  total: number,
  inputs: RethraDesignLandingDeckInputs,
  assets: string,
): string {
...
(function () {
  ...
  function applySlide(n) {
    ...
    /* load-bearing: .slide.active is read by RethraDesign's host bridge
  ...
  /* Host-driven navigation: RethraDesign's host bridge classifies this deck
...
export function renderDeck(inputs: RethraDesignLandingDeckInputs, baseCss: string): string {
...
async function main(): Promise<void> {
  ...
  const inputs = JSON.parse(inputsRaw) as RethraDesignLandingDeckInputs;
