...
Sister design template to [`rethra-design-landing`](../rethra-design-landing/).
...
The deck assumes 16 collage assets at `../rethra-design-landing/assets/`
...
uses `'../rethra-design-landing/assets/'`.

To regenerate or stub:

```bash
# Generate via gpt-image-2 (fal.ai)
FAL_KEY=fal-... npx tsx ../rethra-design-landing/scripts/imagegen.ts \
  ../rethra-design-landing/inputs.example.json \
  --out=../rethra-design-landing/assets/
...
| Old | New |
| --- | --- |
| skill folder `editorial-collage-deck/` | `rethra-design-landing-deck/` |
| shared assets `../editorial-collage/assets/` | `../rethra-design-landing/assets/` |
| TS type `EditorialCollageDeckInputs` | `RethraDesignLandingDeckInputs` |
...
`RethraDesignLandingDeckInputs`.

## See also

- [`rethra-design-landing`](../rethra-design-landing/) — landing-page sister template.
