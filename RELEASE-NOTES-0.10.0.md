...
> 📥 **Download:** assets for `rethra-design-v0.10.0` are built by the prerelease pipeline and publish to GitHub Releases and `releases.rethra-design.invalid` — macOS arm64/Intel `.dmg`, Windows x64 installer — when the build completes.
