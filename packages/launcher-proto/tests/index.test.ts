...
describe("launcher desktop handoff descriptors", () => {
  const prepared: LauncherDesktopHandoffDescriptor = {
    ...
    namespace: "release-beta",
    outer: {
      executablePath: process.platform === "win32" ? "C:\\Program Files\\Rethra Design Beta\\Rethra Design Beta.exe" : "/Applications/Rethra Design Beta.app/Contents/MacOS/Rethra Design Beta",
      pid: 4321,
    },
    payloadExecutablePath: process.platform === "win32" ? "C:\\od-data\\payload\\Rethra Design Beta.exe" : "/tmp/od-data/payload/Rethra Design Beta.app/Contents/MacOS/Rethra Design Beta",
