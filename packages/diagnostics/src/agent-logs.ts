...
export interface AgentCliLogOptions {
  ...
  homeDir: string;
  /** RethraDesign data dir (OD_DATA_DIR); fallback location of the AMR OpenCode home. */
  dataDir?: string | null;
  /**
...
/**
 * Collect the native on-disk logs of the coding-agent CLIs RethraDesign drives:
