...
//
// RethraDesign acts as an MCP CLIENT here: the user configures one or more
...
export interface McpServerConfig {
   ...
   * every run. */
  enabled: boolean;
  /** HTTP/SSE only: whether RethraDesign should offer its managed OAuth flow.
 ...
 * its opener (and broadcasts on the `rethra-design-mcp-oauth` channel). */
