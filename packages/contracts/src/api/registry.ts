...
export type AgentFixIntent =
  ...
  | { kind: 'rescan' }
  /**
   * Prompt the user to point RethraDesign at an explicit binary by writing
...
export type AgentDiagnosticReason =
  ...
  /** The installed CLI version is outside this RethraDesign build's tested set. */
  | 'untested-version'
...
export interface AgentInfo {
  ...
  /** Whether models came from the installed CLI or RethraDesign's static fallback. */
