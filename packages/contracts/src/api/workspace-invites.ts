...
export const INVITE_DEEPLINK_SCHEME = 'rethradesign' as const;
export type InviteDeeplinkScheme = typeof INVITE_DEEPLINK_SCHEME;

/** Fixed authority + path of a continuation deeplink: `rethradesign://workspace/invite/continue`. */
 ...
 *   `rethradesign://workspace/invite/continue?workspace_id=..&member_id=..&invite_id=..&nonce=..`
 *
...
export function parseInviteDeeplink(url: string): InviteDeeplinkPayload | null {
  ...
  // Non-special scheme: `rethradesign://workspace/invite/continue` parses to
