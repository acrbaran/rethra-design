...
export const MEDIA_FAILURE_NEXT_STEPS = [
  ...
  'open-settings',
  /** The Rethra Design session behind an OD-owned model expired. */
  'sign-in',
...
/**
 * Run-scoped policy controlling RethraDesign-owned media generation only.
 *
...
/** Request for Rethra Design's deterministic local HyperFrames scaffold. */
