...
// segment keeps the route collision-free and lets `rethra-design/foo` (registry
...
export const RETHRA_DESIGN_SITE_ORIGIN = 'https://rethra-design.invalid';
...
// `rethra-design/Hero Deck` -> `hero-deck`, `live-dashboard` -> `live-dashboard`.
...
// `rethra-design/Hero Deck` -> `rethra-design/hero-deck`. Used for the namespaced
...
export function pluginShareUrl(
  id: string,
  origin: string = RETHRA_DESIGN_SITE_ORIGIN,
): string {
