...
Do not replace the selected/existing scaffold with Rethra Design's canonical skeleton. Do not rewrite its navigation runtime, add a second navigation runtime, or copy OD Deck Protocol v1 markers into a legacy seed. The host viewer's compatibility bridge owns navigation for legacy deck shapes. If the existing scaffold already implements OD Deck Protocol v1, preserve it as-is.
