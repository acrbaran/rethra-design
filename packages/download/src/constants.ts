...
export const STORE_SENTINEL = ".rethra-design-download-root.json";
...
export const STORE_KIND = "rethra-design-managed-download-root";
/** Kind tag identifying a managed-download manifest. */
export const MANIFEST_KIND = "rethra-design-managed-download";
