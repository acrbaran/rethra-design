 ...
 * ownership sentinel that marks a base directory as RethraDesign-owned, refuses to
...
/**
 * Ensure `basePath` is an RethraDesign-owned managed base: create it if missing,
