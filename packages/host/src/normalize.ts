 ...
 */
export function normalizeRethraDesignHostProjectImportResult(input: unknown): RethraDesignHostProjectImportResult {
  if (!isRecord(input)) {
 ...
 */
export function normalizeRethraDesignHostProjectReplaceWorkingDirResult(
  input: unknown,
): RethraDesignHostProjectReplaceWorkingDirResult {
  if (!isRecord(input)) {
 ...
 */
export function normalizeRethraDesignHostPickWorkingDirResult(
  input: unknown,
): RethraDesignHostPickWorkingDirResult {
  if (!isRecord(input)) {
