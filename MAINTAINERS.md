...
a Maintainer of `acrbaran/rethra-design`. The Core Team's individual roster is
...
| **Core Team** | Rethra Design's internal team. Holds full repository write access and is the final authority on governance decisions. Roster maintained internally. |
...
- **≥ 20 merged PRs** to `acrbaran/rethra-design`.
...
While `acrbaran/rethra-design` is younger than six months from initial commit,
