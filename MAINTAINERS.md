...
a Maintainer of `nexu-io/rethra-design`. The Core Team's individual roster is
...
- **≥ 20 merged PRs** to `nexu-io/rethra-design`.
...
While `nexu-io/rethra-design` is younger than six months from initial commit,
