...
# Fetches the latest od-contribute skill from acrbaran/rethra-design and installs
...
#
#      curl -sSL https://raw.githubusercontent.com/acrbaran/rethra-design/main/.claude/skills/od-contribute/install.sh | bash
#
