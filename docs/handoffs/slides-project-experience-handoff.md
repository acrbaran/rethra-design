...
```bash
PATH=/Users/pftom/.nvm/versions/node/v24.15.0/bin:$PATH pnpm --filter @rethra-design/web typecheck
PATH=/Users/pftom/.nvm/versions/node/v24.15.0/bin:$PATH pnpm --filter @rethra-design/web exec vitest run -c vitest.config.ts tests/runtime/speaker-notes.test.ts tests/runtime/srcdoc-deck-bridge-framework-deck.test.ts tests/components/FileViewer.test.tsx
