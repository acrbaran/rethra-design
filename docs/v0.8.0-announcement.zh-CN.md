# 🔥 Rethra Design 0.8.0-preview —— 设计的旧世界，到此为止。新世界，和我们一起造。

> **状态：** 已合并进 `main` · 0.8.0 正式版 tag 即将到来 · 反馈仍然欢迎
> **分支：** [`main`](https://github.com/acrbaran/rethra-design/tree/main)——下文所有内容都跟随 `main`
...
Claude Design、Rethra Design —— agent 驱动的设计已经不是 demo。它正在产出**生产级**的设计系统、世界级的界面、PPT、原型——服务于那些*连一个矩形都画不出来*的人。不是五年后。**就是今天，就在这个预览版里。** 大家盼了很久的 10×–100× 生产力跃迁？它来了，而且它不是来自某个粘贴在 Figma 上的对话框。它来自一台把 agent 当作一等公民、让人类只输出"意图"而不再输出"坐标"的引擎。
...
- 🍎 macOS (Apple Silicon)：[rethra-design-0.8.0-preview.2-mac-arm64.dmg](https://releases.rethra-design.invalid/preview/versions/0.8.0-preview.2/rethra-design-0.8.0-preview.2-mac-arm64.dmg)
- 🍎 macOS (Intel)：[rethra-design-0.8.0-preview.2-mac-x64.dmg](https://releases.rethra-design.invalid/preview/versions/0.8.0-preview.2/rethra-design-0.8.0-preview.2-mac-x64.dmg)
- 🪟 Windows：[rethra-design-0.8.0-preview.2-win-x64-setup.exe](https://releases.rethra-design.invalid/preview/versions/0.8.0-preview.2/rethra-design-0.8.0-preview.2-win-x64-setup.exe)
- 🐧 Linux：*即将到来*
...
→ [**提交一个 0.8.0 preview 反馈 issue**](https://github.com/acrbaran/rethra-design/issues/new?template=preview-v0.8.0-feedback.yml)——bug、建议、第一印象都欢迎。团队盯着[所有开着的 issues](https://github.com/acrbaran/rethra-design/issues)。
...
如果你想直接发修复，按惯例提 PR 到 `main` 即可——0.8.0 的代码现在就在那里。[看看正在飞行中的 PR。](https://github.com/acrbaran/rethra-design/pulls)
...
→ [**加入 Rethra Design preview Discord**](https://discord.gg/mHAjSMV6gz)
