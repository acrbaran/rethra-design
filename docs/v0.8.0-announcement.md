# 🔥 Rethra Design 0.8.0-preview — Design's old world ends here. Help us build the new one.

> **Status:** Now landed on `main` · 0.8.0 release tag coming up · feedback still wanted
> **Branch:** [`main`](https://github.com/acrbaran/rethra-design/tree/main) — everything below tracks `main`
...
→ [**Open a 0.8.0 preview feedback issue**](https://github.com/acrbaran/rethra-design/issues/new?template=preview-v0.8.0-feedback.yml) — bugs, suggestions, first impressions, all welcome. The team watches [all open issues](https://github.com/acrbaran/rethra-design/issues).
...
If you want to send a fix instead, open a PR against `main` as usual — 0.8.0 work now lives there. [See what's open.](https://github.com/acrbaran/rethra-design/pulls)
...
→ [**Join the Rethra Design preview Discord**](https://discord.gg/mHAjSMV6gz)
