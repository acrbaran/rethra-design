---
title: Rethra Design 0.14.1
description: Opt in to silent updates that are applied the next time Rethra Design starts.
---

## Silent updates

You can now allow Rethra Design to apply a downloaded update silently the next
