---
title: Rethra Design 0.19.1 — Design with DeepSeek Harness
description: Connect your official DeepSeek Harness installation to Rethra Design for model discovery, structured runs, and session resume. Paid plans also get DeepSeek V4 Pro and Flash unlimited for two weeks.
---

### 🌟 Codename: *Design with DeepSeek Harness*

🧰 **59 PRs · 24 contributors · 4 days** — **DeepSeek Harness now runs as an
agent inside Rethra Design.** Rethra Design finds your official `dsh`, guides setup
of the Rethra Design connection profile, lists Harness models and
...
- 🧰 **Bring your official DeepSeek Harness installation into Rethra Design.**
  Rethra Design discovers `dsh`, reads its model and reasoning choices, and gives
  ...
  repair only the Rethra Design connection profile; Rethra Design does not replace
...
- 🎁 **Paid plans get two weeks of unlimited DeepSeek V4 Pro and Flash.**
  ...
  once. When a rolling model window fills up, Rethra Design shows the retry time
...
- 🏠 **Home gets you into a project sooner.** The refreshed Home adds a
  ...
  Cloud projects keep their balance checks. After you submit, Rethra Design moves
...
- `od mcp install claude-desktop` can configure Rethra Design for Claude Desktop
...
- Launch Week is easier to discover from the landing page, and community links
  are labeled before they take you away from Rethra Design. (#6680, #6684)
