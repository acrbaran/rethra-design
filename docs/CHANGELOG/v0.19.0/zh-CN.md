...
description: 用 Rethra Design 订阅把想法变成图片：直接使用 Seedream 5.0 Pro、GPT Image 2.0 和 Nano Banana 2.0 生成图像。
---

### 🌟 Codename: *Image Generation, Unlocked*

🖼️ **用 Rethra Design 订阅把想法变成图片：直接使用 Seedream 5.0 Pro、GPT Image 2.0
和 Nano Banana 2.0 生成图像。**

## 🔥 亮点

- 🎨 **订阅内直接使用三款主力图片模型。** 通过 Rethra Design Cloud，可以直接使用
...
稳定版发布后，可通过应用内正常更新流程升级到 Rethra Design 0.19.0，也可以下载安装包。
本次发布没有额外的手动操作说明。
