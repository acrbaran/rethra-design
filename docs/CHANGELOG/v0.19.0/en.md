---
title: Rethra Design 0.19.0 — Image Generation, Unlocked
description: Bring ideas to life with your Rethra Design subscription—generate images directly with Seedream 5.0 Pro, GPT Image 2.0, and Nano Banana 2.0.
---

### 🌟 Codename: *Image Generation, Unlocked*

🖼️ **Bring ideas to life with your Rethra Design subscription—generate images
...
- 🎨 **Three flagship image models, included with your subscription.** Generate
  ...
  Banana 2.0 through Rethra Design Cloud. The agent can pass multiple reference
...
Install Rethra Design 0.19.0 through the normal in-app update flow or the current
