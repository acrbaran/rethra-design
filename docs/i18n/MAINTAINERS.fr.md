...
| **Core Team** | L'équipe interne d'Rethra Design. Détient un accès en écriture complet sur le repository et constitue l'autorité finale sur les décisions de gouvernance. La liste est tenue en interne. |
