...
- **≥ 20 merged PRs** zu `nexu-io/rethra-design`.
...
Solange `nexu-io/rethra-design` jünger als sechs Monate seit dem initialen Commit ist, kann das Veto zur **projektübergreifenden Aktivität** (#6) durch Konsens des Core Teams ausgesetzt werden, wenn:
