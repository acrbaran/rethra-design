...
เอกสารนี้กำหนดกติกาสำหรับการเป็น, การทำหน้าที่ และการ step down จากบทบาท Maintainer ของ `acrbaran/rethra-design`. รายชื่อรายบุคคลของ Core Team ถูก maintain ภายในและไม่ได้ enumerate ไว้ที่นี่ — สิ่งที่สำคัญต่อสาธารณะคือกติกาที่ทุกคนเล่นตาม.
...
- **≥ 20 merged PRs** ไปยัง `acrbaran/rethra-design`.
...
ขณะที่ `acrbaran/rethra-design` ยังอายุน้อยกว่าหกเดือนจาก initial commit, veto ด้าน **cross-project activity** (#6) อาจ waive ได้โดย Core Team consensus เมื่อ:
