...
Maintainer de `nexu-io/rethra-design`. A composição individual do Core Team é
...
- **≥ 20 merged PRs** em `nexu-io/rethra-design`.
...
Enquanto `nexu-io/rethra-design` tiver menos de seis meses desde o commit inicial,
