...
| DESK-102 | 全新 mac 打包应用的 onboarding 会同时呈现 Rethra Design Cloud、Local CLI 与 BYOK 路径 | `OD_PACKAGED_E2E_MAC=1` + `OD_PACKAGED_E2E_MAC_ONBOARDING_SMOKE=1` | `mac.spec.ts` |
