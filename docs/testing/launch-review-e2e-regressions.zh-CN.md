...
文件：
- [e2e/ui/workspace-keyboard-flows.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e/ui/workspace-keyboard-flows.test.ts)
- [e2e/ui/app-restoration.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e/ui/app-restoration.test.ts)
...
文件：
- [e2e/ui/app-restoration.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e/ui/app-restoration.test.ts)
- [e2e/ui/app-manual-edit.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e/ui/app-manual-edit.test.ts)
...
文件：
- [e2e/lib/fake-agents.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e/lib/fake-agents.ts)
- [e2e/ui/real-daemon-run.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e/ui/real-daemon-run.test.ts)
...
文件：
- [e2e/ui/app.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e/ui/app.test.ts)
...
文件：
- [e2e/ui/diagnostics-export.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e/ui/diagnostics-export.test.ts)
...
文件：
- [e2e/ui/settings-connectors-auth-happy-path.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e/ui/settings-connectors-auth-happy-path.test.ts)
- [e2e/ui/settings-connectors-auth-recovery.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e/ui/settings-connectors-auth-recovery.test.ts)
...
文件：
- [e2e/ui/design-systems-manager.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e/ui/design-systems-manager.test.ts)
...
文件：
- [e2e/ui/project-management-flows.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e/ui/project-management-flows.test.ts)
- [e2e/ui/amr-onboarding.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e/ui/amr-onboarding.test.ts)
- [e2e/ui/app-manual-edit.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e/ui/app-manual-edit.test.ts)
- [e2e/ui/settings-api-protocol.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e/ui/settings-api-protocol.test.ts)
...
```bash
cd /Users/mac/rethra-design/rethra-design-amr-runtime-acp/e2e
```
...
文件：
- [apps/daemon/tests/diagnostics-export.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/apps/daemon/tests/diagnostics-export.test.ts)
...
文件：
- [apps/daemon/tests/projects-routes.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/apps/daemon/tests/projects-routes.test.ts)
...
文件：
- [apps/daemon/tests/runs.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/apps/daemon/tests/runs.test.ts)
...
文件：
- [apps/daemon/tests/amr-acp-integration.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/apps/daemon/tests/amr-acp-integration.test.ts)
- [apps/daemon/src/runtimes/defs/amr.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/apps/daemon/src/runtimes/defs/amr.ts)
...
文件：
- [apps/daemon/tests/chat-route.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/apps/daemon/tests/chat-route.test.ts)
- [apps/daemon/src/server.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/apps/daemon/src/server.ts)
...
文件：
- [apps/daemon/tests/runtimes/agent-args.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/apps/daemon/tests/runtimes/agent-args.test.ts)
- [apps/daemon/src/runtimes/defs/grok-build.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/apps/daemon/src/runtimes/defs/grok-build.ts)
...
文件：
- [apps/daemon/tests/integrations/vela.routes.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/apps/daemon/tests/integrations/vela.routes.test.ts)
...
1. `uses the same Settings-configured AMR env for login and subsequent status reads`
   ...
   - 避免终端里的 `vela` 已登录，但 Rethra Design 因配置源不一致读成未登录
...
文件：
- [apps/daemon/tests/runtimes/env-and-detection.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/apps/daemon/tests/runtimes/env-and-detection.test.ts)
...
文件：
- [apps/daemon/tests/chat-run-artifact-quiet-period.test.ts](/Users/mac/rethra-design/rethra-design-amr-runtime-acp/apps/daemon/tests/chat-run-artifact-quiet-period.test.ts)
...
```bash
cd /Users/mac/rethra-design/rethra-design-amr-runtime-acp/apps/daemon
```
