...
Agent-facing guidance for the Rethra Design curated integration of Cloudflare Kumo UI.
...
- Use Kumo's native `data-mode="dark"` hook; `data-theme="dark"` is included only for Rethra Design artifact compatibility.
- Treat the section, container, and extended heading tokens as Rethra Design compatibility bindings, not upstream Kumo tokens.
