...
describe("resolveMacInstallIdentity", () => {
  it("keeps stable builds on the canonical mac identity", () => {
    expect(resolveMacInstallIdentity(makeConfig("/work", "release-stable"))).toMatchObject({
      ...
      installerTitle: "Rethra Design",
      productName: "Rethra Design",
      publicAppBundleName: "Rethra Design.app",
      systemAppBundleName: "Rethra Design.app",
    });
  });
  ...
  it("uses first-class beta app identity for beta release namespaces", () => {
    ...
    expect(resolveMacInstallIdentity(config)).toEqual({
      appId: "io.rethra-design.desktop.beta",
      executableName: "Rethra Design Beta",
      installerTitle: "Rethra Design Beta",
      productName: "Rethra Design Beta",
      publicAppBundleName: "Rethra Design Beta.app",
      systemAppBundleName: "Rethra Design Beta.app",
    });
    expect(resolveMacPaths(config).appPath).toMatch(/Rethra Design Beta\.app$/);
  });
  ...
  it("uses first-class preview app identity for preview release namespaces", () => {
    ...
    expect(resolveMacInstallIdentity(config)).toEqual({
      appId: "io.rethra-design.desktop.preview",
      executableName: "Rethra Design Preview",
      installerTitle: "Rethra Design Preview",
      productName: "Rethra Design Preview",
      publicAppBundleName: "Rethra Design Preview.app",
      systemAppBundleName: "Rethra Design Preview.app",
    });
    expect(resolveMacPaths(config).appPath).toMatch(/Rethra Design Preview\.app$/);
  });
  ...
  it("uses first-class prerelease app identity for prerelease release versions and namespaces", () => {
    ...
    expect(resolveMacInstallIdentity(prereleaseVersionConfig)).toEqual({
      ...
      installerTitle: "Rethra Design Prerelease",
      productName: "Rethra Design Prerelease",
      publicAppBundleName: "Rethra Design Prerelease.app",
      systemAppBundleName: "Rethra Design Prerelease.app",
    });
    expect(resolveMacPaths(prereleaseVersionConfig).appPath).toMatch(/Rethra Design Prerelease\.app$/);
