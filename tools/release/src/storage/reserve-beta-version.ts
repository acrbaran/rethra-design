...
writeGithubOutputs({
  ...
  release_name: `Rethra Design ${releaseChannel === "betas" ? "Betas" : releaseChannel[0]?.toUpperCase() ?? ""}${releaseChannel === "betas" ? "" : releaseChannel.slice(1)} ${reservation.releaseVersion}`,
