...
import { isReleaseChannel, parseReleaseVersion, type ReleaseChannel } from "@rethra-design/release";
...
export type ReleaseNotePlan = {
  ...
  kind: "rethra-design-release-note-plan";
...
export function parseReleaseNotePlan(value: unknown): ReleaseNotePlan {
  if (!isRecord(value) || value.kind !== "rethra-design-release-note-plan" || value.version !== 1) {
