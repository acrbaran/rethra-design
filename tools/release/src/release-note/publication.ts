import { isReleaseChannel, parseReleaseVersion } from "@rethra-design/release";
...
export type ReleaseNotePublication = {
  ...
  kind: "rethra-design-release-note-publication";
...
export function parseReleaseNotePublication(value: unknown): ReleaseNotePublication {
  if (!isRecord(value) || value.kind !== "rethra-design-release-note-publication" || value.version !== 1) {
