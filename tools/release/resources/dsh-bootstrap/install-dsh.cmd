...
set "OD_DSH_PS1=%TEMP%\rethra-design-install-dsh-%RANDOM%-%RANDOM%.ps1"
rem Immutable R2 publication rewrites this landing URL to the colocated versioned PS1.
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -Command "$ProgressPreference='SilentlyContinue'; Invoke-WebRequest -UseBasicParsing 'https://rethra-design.invalid/install-dsh.ps1?version=1' -OutFile $env:OD_DSH_PS1"
if errorlevel 1 (
