...
case "$RELEASE_TARGET" in
  mac_arm64 | mac_x64)
    ...
    source_dmg="$TOOLS_PACK_DIR/out/mac/namespaces/$RELEASE_NAMESPACE/dmg/Rethra Design-$RELEASE_NAMESPACE.dmg"
    source_zip="$TOOLS_PACK_DIR/out/mac/namespaces/$RELEASE_NAMESPACE/zip/Rethra Design-$RELEASE_NAMESPACE.zip"
    source_payload="$TOOLS_PACK_DIR/out/mac/namespaces/$RELEASE_NAMESPACE/payload/Rethra Design-$RELEASE_NAMESPACE-payload.zip"
    versioned_dmg="rethra-design-$RELEASE_VERSION$RELEASE_ASSET_SUFFIX-mac-$arch.dmg"
    versioned_zip="rethra-design-$RELEASE_VERSION$RELEASE_ASSET_SUFFIX-mac-$arch.zip"
    versioned_payload="rethra-design-$RELEASE_VERSION$RELEASE_ASSET_SUFFIX-mac-$arch-payload.zip"
    ...
    release_notes="${RELEASE_NOTES:-Rethra Design $RELEASE_VERSION$RELEASE_ASSET_SUFFIX}"
...
EOF
    ;;
  linux_x64)
    source_appimage="$TOOLS_PACK_DIR/out/linux/namespaces/$RELEASE_NAMESPACE/builder/Rethra Design-$RELEASE_NAMESPACE.AppImage"
    versioned_appimage="rethra-design-$RELEASE_VERSION$RELEASE_ASSET_SUFFIX-linux-x64.AppImage"
