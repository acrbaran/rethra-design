...
$versionedInstaller = "rethra-design-$ReleaseVersion$ReleaseAssetSuffix-win-x64-setup.exe"
$versionedPayload = "rethra-design-$ReleaseVersion$ReleaseAssetSuffix-win-x64-payload.7z"
$versionedZip = "rethra-design-$ReleaseVersion$ReleaseAssetSuffix-win-x64-portable.zip"
...
$notes = if ([string]::IsNullOrWhiteSpace($ReleaseNotes)) {
  "Rethra Design $ReleaseVersion$ReleaseAssetSuffix"
} else {
  $ReleaseNotes
}
