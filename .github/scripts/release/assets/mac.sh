...
source_dmg="$tools_pack_dir/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/dmg/Rethra Design-$TOOLS_PACK_NAMESPACE.dmg"
source_zip="$tools_pack_dir/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/zip/Rethra Design-$TOOLS_PACK_NAMESPACE.zip"
...
versioned_dmg="rethra-design-${RELEASE_VERSION}${asset_suffix}-mac-arm64.dmg"
versioned_zip="rethra-design-${RELEASE_VERSION}${asset_suffix}-mac-arm64.zip"
...
release_notes="${RELEASE_NOTES:-Rethra Design $RELEASE_VERSION$asset_suffix}"
