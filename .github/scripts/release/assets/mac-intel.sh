...
source_dmg="$RUNNER_TEMP/tools-pack/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/dmg/Rethra Design-$TOOLS_PACK_NAMESPACE.dmg"
source_zip="$RUNNER_TEMP/tools-pack/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/zip/Rethra Design-$TOOLS_PACK_NAMESPACE.zip"
...
versioned_dmg="rethra-design-${RELEASE_VERSION}${asset_suffix}-mac-x64.dmg"
versioned_zip="rethra-design-${RELEASE_VERSION}${asset_suffix}-mac-x64.zip"
