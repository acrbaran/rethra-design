...
$installerName = "rethra-design-$releaseVersion$assetSuffix-win-x64-setup.exe"
$portableZipName = "rethra-design-$releaseVersion$assetSuffix-win-x64-portable.zip"
...
Write-Utf8File -Path (Join-Path $releaseDir "latest.yml") -Content @(
  ...
  "releaseNotes: `"RethraDesign beta $releaseVersion$assetSuffix`""
)
