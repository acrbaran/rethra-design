...
const plugin: InstalledPluginRecord = {
  ...
  version: '0.1.0',
  sourceKind: 'github',
  source: 'github:acrbaran/rethra-design@main/plugins/community/registry-starter',
  ...
  resolvedSource: 'github:acrbaran/rethra-design@main/plugins/community/registry-starter',
  resolvedRef: 'main',
