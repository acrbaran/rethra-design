...
const plugin: InstalledPluginRecord = {
  ...
  version: '0.1.0',
  sourceKind: 'github',
  source: 'github:nexu-io/rethra-design@main/plugins/community/registry-starter',
  ...
  resolvedSource: 'github:nexu-io/rethra-design@main/plugins/community/registry-starter',
  resolvedRef: 'main',
