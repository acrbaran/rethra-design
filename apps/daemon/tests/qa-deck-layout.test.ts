...
const VALID_BRAND = {
  ...
  description:
    'RethraDesign is the official open-source, local-first alternative to Claude Design — an agent-native design platform that turns the coding agent into a full design studio, generating on-brand artifacts from a single source of truth.',
  colors: [
...
function renderRealDeck(): string {
  const brand = validateBrand({ ...VALID_BRAND }, 'https://rethra-design.invalid');
