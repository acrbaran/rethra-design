...
describe('od message-center CLI', () => {
  ...
  it('lists messages through the daemon route and maps locale/filter query params', async () => {
            ...
            messages: [
              {
                ...
                title: 'RethraDesign 0.14 is available',
    ...
    expect(result.stdout).toContain('release\tunread\tProduct update\t2026-07-16T12:00:00.000Z\tRethraDesign 0.14 is available');
