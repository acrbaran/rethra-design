...
import {
  codexAgentDef,
  codexRethraDesignShellEnvironmentArgs,
...
describe('codex buildArgs session resume', () => {
  ...
  it('carries only the RethraDesign wrapper contract across Codex shell environment filtering', () => {
    const args = codexAgentDef.buildArgs('prompt', [], [], {}, {});
    const shellArgs = codexRethraDesignShellEnvironmentArgs();
