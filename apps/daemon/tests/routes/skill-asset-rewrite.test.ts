...
describe('rewriteSkillAssetUrls', () => {
  it('rewrites ./assets/<file> img sources to the daemon route', () => {
    ...
    expect(rewriteSkillAssetUrls(html, 'rethra-design-landing')).toBe(
      `<img src='/api/skills/rethra-design-landing/assets/hero.png' alt='' />`,
    );
  });
  ...
  it('rewrites sibling skill asset references', () => {
    const html = `<img src='../rethra-design-landing/assets/hero.png' /><a href="../skill-two/assets/guide.pdf"></a>`;
    expect(rewriteSkillAssetUrls(html, 'foo')).toBe(
      `<img src='/api/skills/rethra-design-landing/assets/hero.png' /><a href="/api/skills/skill-two/assets/guide.pdf"></a>`,
    );
  });
