...
beforeEach(() => {
  ...
  originalProfile = process.env.RETHRA_DESIGN_AMR_PROFILE;
...
afterEach(() => {
  ...
  if (originalProfile === undefined) delete process.env.RETHRA_DESIGN_AMR_PROFILE;
  else process.env.RETHRA_DESIGN_AMR_PROFILE = originalProfile;
