...
describe('resolveSafeProjectAttachments', () => {
  it('keeps Windows attachments when root and attachment path use different separators and drive casing', () => {
    const existing = new Set([
      'C:\\Users\\Designer\\Rethra Design\\m5-logo.png',
      'c:\\users\\designer\\rethra design\\assets\\mark.png',
    ]);

    const safe = resolveSafeProjectAttachments(
      'C:/Users/Designer/Rethra Design/',
      [
        'm5-logo.png',
        'c:/users/designer/rethra design/assets/mark.png',
        'C:/Users/Designer/Rethra Design Adjacent/secret.png',
        '..\\secret.png',
      ],
      {
