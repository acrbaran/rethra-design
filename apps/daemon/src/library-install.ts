...
// Installed items live under ~/.rethra-design/skills/ and
// ~/.rethra-design/design-systems/ respectively.
 ...
 * @param {string} userDir - user-installed directory (e.g. ~/.rethra-design/skills)
