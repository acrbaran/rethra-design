...
import { extractComponentsManifest } from '@rethra-design/contracts/design-systems/components-manifest';
import { renderDesignTokensJson, renderTailwindV4Css } from '@rethra-design/contracts/design-systems/derived-token-outputs';
import {
...
function renderUsageMd(name: string, scan: ProjectScan): string {
  ...
  return [
    `# ${name} Usage`,
    '',
    '> Auto-generated by RethraDesign importer. Review and edit before treating it as a canonical brand guide.',
    '',
    '## Read Order',
    '',
