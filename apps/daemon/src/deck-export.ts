...
import { injectDeckStageFallback } from '@rethra-design/contracts/runtime/deck-stage-fallback';
import type { DesktopRenderSlidesInput } from '@rethra-design/sidecar-proto';
