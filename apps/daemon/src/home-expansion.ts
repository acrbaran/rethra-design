 ...
 * $HOME/.rethra-design lands every daemon write at the same expanded path.
 *
 ...
 * prefix so a Windows launcher passing $HOME\.rethra-design behaves the same
 * as a Unix launcher passing $HOME/.rethra-design; the result is rebuilt via
