...
import type { CritiqueConfig, DegradedReason, PanelEvent, PanelistRole } from '@rethra-design/contracts/critique';
import { CRITIQUE_PROTOCOL_VERSION, defaultCritiqueConfig } from '@rethra-design/contracts/critique';
