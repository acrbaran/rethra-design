...
// tsconfig does not resolve the `@rethra-design/contracts/api/chat` subpath
...
} from '@rethra-design/contracts/api/finalize';
...
// canonical definitions live in @rethra-design/contracts/api/finalize
