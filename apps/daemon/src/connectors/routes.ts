...
<html lang="en">
  <head>
    ...
    <title>${connectorLabelHtml} connected · RethraDesign</title>
    <style>
      :root {
        --bg: #faf9f7;
        --bg-panel: #ffffff;
  ...
  <body>
    <main aria-labelledby="callback-title">
      <div class="chrome" aria-label="RethraDesign">
        <span class="brand-mark" aria-hidden="true">OD</span>
        <span class="brand-title">RethraDesign</span>
      </div>
      <section class="content">
        ...
        <div>
          ...
          <p>Your connector is ready to use in RethraDesign.</p>
        </div>
    ...
    <script>
      (() => {
        ...
        const message = { type: 'rethra-design:connector-connected', connectorId, connectorLabel };
        ...
        function showManualCloseHint() {
          ...
          hint.textContent = 'Your browser blocked automatic closing. You can close this tab and return to RethraDesign.';
        }
        ...
        try {
          if (hasLiveOpener()) {
            ...
            hint.textContent = 'You can close this tab and return to RethraDesign.';
          }
        } catch {
          hint.textContent = 'You can close this tab and return to RethraDesign.';
        }
