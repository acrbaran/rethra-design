...
import type { OrbitRunSummary, OrbitStatusResponse } from '@rethra-design/contracts/api/orbit';
...
export function buildOrbitSystemPrompt(
  ...
  const lines = [
    ...
    '- Code: “rethra-design had 4 repositories updated. The most notable change was a daemon update that affects data refresh behavior, so review it before the next release.”',
