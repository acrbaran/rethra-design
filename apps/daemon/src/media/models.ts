...
export const MEDIA_PROVIDERS: MediaProvider[] = [
  ...
  { id: 'vela', label: 'RethraDesign Cloud', hint: 'Managed image and video generation through Vela', integrated: true, credentialsRequired: false, settingsVisible: false },
...
export const IMAGE_MODELS: MediaModel[] = [
  { id: 'vela/gpt-image-2', label: 'gpt-image-2 (Cloud)', hint: 'RethraDesign Cloud · managed image generation and editing', provider: 'vela', caps: ['t2i', 'i2i'], default: true },
  { id: 'vela/nano-banana-2', label: 'nano-banana-2 (Cloud)', hint: 'RethraDesign Cloud · managed image generation and editing', provider: 'vela', caps: ['t2i', 'i2i'] },
  { id: 'vela/nano-banana-2-lite', label: 'nano-banana-2-lite (Cloud)', hint: 'RethraDesign Cloud · fast managed image generation and editing', provider: 'vela', caps: ['t2i', 'i2i'] },
  { id: 'vela/seedream-5.0', label: 'seedream-5.0 (Cloud)', hint: 'RethraDesign Cloud · managed image generation and editing', provider: 'vela', caps: ['t2i', 'i2i'] },
  { id: 'vela/seedream-5.0-pro', label: 'seedream-5.0-pro (Cloud)', hint: 'RethraDesign Cloud · high-quality managed image generation and editing', provider: 'vela', caps: ['t2i', 'i2i'] },
...
export const VIDEO_MODELS: MediaModel[] = [
  { id: 'vela/doubao-seedance-2-0-260128', label: 'seedance-2.0 (Cloud)', hint: 'RethraDesign Cloud · managed text/image-to-video · 720p default', provider: 'vela', caps: ['t2v', 'i2v'] },
