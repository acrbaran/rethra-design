 ...
 * Generation-1 wire contract for the RethraDesign DeepSeek Harness profile.
 * The user's official `dsh` owns the runtime; this protocol is the thin stdio
 * seam exposed by the installed `rethra-design` profile bundle.
 */

export const DSH_PROFILE_PROTOCOL_VERSION = 1 as const;
export const DSH_PROFILE_RUNTIME = 'rethra-design' as const;
export const DSH_PROFILE_NAME = 'rethra-design' as const;
