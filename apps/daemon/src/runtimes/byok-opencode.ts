import type { ByokChatProviderConfig } from '@rethra-design/contracts';

export const BYOK_OPENCODE_AGENT_ID = 'byok-opencode';
export const BYOK_OPENCODE_PROVIDER_ID = 'rethra-design-byok';
export const BYOK_OPENCODE_API_KEY_ENV = 'RETHRA_DESIGN_BYOK_API_KEY';
