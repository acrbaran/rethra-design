...
// `inherit = "core"` policy removes every RethraDesign wrapper variable, so a
...
// remain unavailable unless they are one of the explicit RethraDesign
...
export function codexRethraDesignShellEnvironmentArgs(): string[] {
...
export const codexAgentDef = {
    ...
    buildArgs: (
      ...
      args.push(...codexRethraDesignShellEnvironmentArgs());
 ...
 *
 *  - the RethraDesign shell-environment policy, byte-identical to the exec path,
