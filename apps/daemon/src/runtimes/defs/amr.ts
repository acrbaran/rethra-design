...
import type { ModelCapability, ModelCost, ModelMetadata } from '@rethra-design/contracts';
...
//      the link-facing slug (`deepseek-v3.2` / `glm-5.1`), so RethraDesign
...
function isVelaChatModelId(modelId: string): boolean {
  ...
  // but RethraDesign's AMR runtime currently drives only chat completions.
