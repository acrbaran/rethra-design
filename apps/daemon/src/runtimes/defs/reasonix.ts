...
// REASONIX_ACP_SYSTEM_APPEND. This ensures the model follows RethraDesign's
// design workflow (artifact output, design system, skill instructions)
// instead of treating every request as a pure coding task.
const DESIGN_INSTRUCTIONS = `# RethraDesign integration — MUST follow

You are running inside RethraDesign, a design tool. The user message contains
