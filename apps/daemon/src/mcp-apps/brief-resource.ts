export const RETHRA_DESIGN_BRIEF_APP_VERSION = 'v8' as const;
 ...
 */
export const RETHRA_DESIGN_BRIEF_APP_HTML = String.raw`<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <script>
      (() => {
        ...
        standardBridgeInitialization = request("ui/initialize", {
          ...
          appInfo: { name: "rethra-design-brief", version: "v8" },
          appCapabilities: {},
        }).then((result) => {
