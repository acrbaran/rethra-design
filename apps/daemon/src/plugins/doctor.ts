...
//
//   - Validates the manifest using @rethra-design/plugin-runtime's validateSafe.
...
import { manifestSourceDigest, resolveContext, validateSafe, type RegistryView } from '@rethra-design/plugin-runtime';
