 ...
 *
 * Nine series, all under the `rethra_design_critique_*` namespace, scoped
...
export const critiqueRunsTotal = new Counter({
  name: 'rethra_design_critique_runs_total',
...
export const critiqueRoundsTotal = new Counter({
  name: 'rethra_design_critique_rounds_total',
...
export const critiqueRoundDurationMs = new Histogram({
  name: 'rethra_design_critique_round_duration_ms',
...
export const critiqueCompositeScore = new Histogram({
  name: 'rethra_design_critique_composite_score',
...
export const critiqueMustFixTotal = new Counter({
  name: 'rethra_design_critique_must_fix_total',
...
export const critiqueDegradedTotal = new Counter({
  name: 'rethra_design_critique_degraded_total',
...
export const critiqueInterruptedTotal = new Counter({
  name: 'rethra_design_critique_interrupted_total',
...
export const critiqueParserErrorsTotal = new Counter({
  name: 'rethra_design_critique_parser_errors_total',
...
export const critiqueProtocolVersion = new Gauge({
  name: 'rethra_design_critique_protocol_version',
