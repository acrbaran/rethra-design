import type { AppConfigPrefs } from '@rethra-design/contracts';
...
export interface KnownProvider {
  ...
  /** Model ids that RethraDesign previously preselected but the provider retired. */
...
export const KNOWN_PROVIDERS: KnownProvider[] = [
  ...
  },
  {
    ...
    apiKeyConsoleLink: {
      host: 'atlascloud.ai',
      url: 'https://atlascloud.ai/?utm_source=rethra_design&utm_medium=provider_preset&utm_campaign=atlascloud_byok',
    },
  },
  {
    label: 'OpenRouter',
