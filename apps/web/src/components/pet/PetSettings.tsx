...
export function PetSettings({ cfg, setCfg }: Props) {
  ...
  // who've resized or recompressed a hatched pet outside RethraDesign.
  ...
  const hatchPrompt = useMemo(() => {
    ...
    return [
      ...
      '',
      'When the spritesheet is saved, tell me the absolute path so I can import it into RethraDesign via Settings → Pets → Import Codex sprite.',
    ].join('\n');
  }, [hatchConcept]);
