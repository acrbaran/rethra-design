...
import { Button, Textarea } from '@rethra-design/components';
...
function DesignKitViewInner({
  ...
  function rethraDesignMdModuleEditor(module: DesignMdModuleSpec) {
    if (!designMd) return;
  ...
  function designMdActionButtons() {
    ...
    return (
      <>
        ...
        {canEditDesignMd
          ? moduleActionButton(t('ds.editDesignMd'), 'edit', rethraDesignMdEditor, Boolean(designMd.saving || anyActionBusy))
          : designMd.onOpenFile
            ? moduleActionButton(t('ds.rethraDesignMd'), 'file-text', designMd.onOpenFile)
            : null}
        {canEditDesignMd
  ...
  function designMdModuleActionButtons(module: DesignMdModuleSpec) {
    ...
    return (
      <>
        ...
        {canEditDesignMd
          ? moduleActionButton(t('ds.editDesignMdModule', moduleVars), 'edit', () => rethraDesignMdModuleEditor(module), Boolean(designMd.saving || anyActionBusy))
          : designMd.onOpenFile
            ? moduleActionButton(t('ds.rethraDesignMdModule', moduleVars), 'file-text', designMd.onOpenFile)
            : null}
      </>
    );
  }
