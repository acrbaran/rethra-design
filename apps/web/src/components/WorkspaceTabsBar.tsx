...
const STORAGE_KEY = 'rethra-design:workspace-tabs:v1';
const OPEN_WORKSPACE_TAB_EVENT = 'rethra-design:workspace-tabs:open';
const REMOVE_WORKSPACE_PROJECT_TABS_EVENT = 'rethra-design:workspace-tabs:remove-project';
