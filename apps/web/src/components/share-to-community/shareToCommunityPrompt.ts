// Trigger prompt for the post-completion "Share to RethraDesign" submission
...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as an RethraDesign plugin so I can install it into My plugins and open a PR to the RethraDesign community catalog.',
  '',
  ...
  '- rethra-design.json with valid metadata: specVersion, name, version, description, mode, task kind, inputs, plus any pipeline / context references the workflow needs',
  ...
  '- **RethraDesign PR** — opens a draft PR against `acrbaran/rethra-design` for the community catalog.',
  '',
