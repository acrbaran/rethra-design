...
const TOGGLE_EVENT = 'rethra-design:critique-theater-toggle';
 ...
 *
 * Source of truth is the existing `rethra-design:config` localStorage
 ...
 *   2. A same-tab `rethra-design:critique-theater-toggle` CustomEvent so
