...
interface Props {
  ...
  /** RethraDesign Cloud profile from the blocking snapshot; picks the console origin. */
  profile: string | null;
...
// HARD pre-run blocker for RethraDesign Cloud tasks: the run cannot possibly
...
//
//   signed_out — RethraDesign Cloud selected but no account session. The CTA
...
export function AmrBalanceDialog({
  ...
  const openUpgrade = () => {
    ...
    // Same attribution handshake as the other RethraDesign Cloud handoffs
