...
import type { ProjectKind, ProjectMetadata } from '@rethra-design/contracts';
import type { DefaultScenarioPluginId } from '@rethra-design/contracts';
...
export const HOME_HERO_CHIPS: ReadonlyArray<HomeHeroChip> = [
  ...
  },
  {
    ...
    icon: 'edit',
    group: 'migrate',
    hint: 'Author a reusable RethraDesign plugin and add it to My plugins.',
...
export const HOME_APPLY_TEMPLATE_EVENT = 'rethra-design:home-apply-template';
