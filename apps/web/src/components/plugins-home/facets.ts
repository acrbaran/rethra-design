...
import { resolveLocalizedText, type InstalledPluginRecord } from '@rethra-design/contracts';
...
const PRIMARY_CATEGORIES: readonly CategoryDef[] = [
  {
    slug: 'deck',
    label: 'Slides',
    starterPrompt: 'Create an RethraDesign plugin that generates a polished slide deck from a narrative brief.',
    test: byMode('deck'),
  },
  {
    slug: 'prototype',
    label: 'Prototype',
    starterPrompt: 'Create an RethraDesign plugin that generates an interactive prototype from a product brief.',
    test: (record) => byMode('prototype')(record) && !isLiveArtifactPlugin(record),
  },
  {
    slug: 'live-artifact',
    label: 'Live Artifact',
    starterPrompt: 'Create an RethraDesign plugin that generates a live artifact with refreshable, data-aware UI.',
    test: isLiveArtifactPlugin,
  },
  {
    slug: 'image',
    label: 'Image',
    starterPrompt: 'Create an RethraDesign plugin that generates image assets from structured creative direction.',
    test: byMode('image'),
  },
  {
    slug: 'video',
    label: 'Video',
    starterPrompt: 'Create an RethraDesign plugin that generates video prompts, storyboards, or render-ready motion artifacts.',
    test: isVideoPlugin,
  },
  {
    slug: 'hyperframes',
    label: 'HyperFrames',
    starterPrompt: 'Create an RethraDesign plugin that generates a HyperFrames-ready motion composition.',
    test: isHyperFramesPlugin,
  },
  {
    slug: 'audio',
    label: 'Audio',
    starterPrompt: 'Create an RethraDesign plugin that generates audio, voice, or sound-design assets from a brief.',
    test: byMode('audio'),
  },
];
...
const DECK_SUBCATEGORIES: readonly SubcategoryDef[] = DECK_COMMERCIAL_ORDER.map((id) => ({
  ...
  starterPrompt: `Create an RethraDesign deck plugin for the ${DECK_COMMERCIAL_LABELS[id]} scene — a decision-grade slide deck with the structure, language, and visual discipline that scene's audience expects.`,
...
const SUBCATEGORIES: readonly SubcategoryDef[] = [
  {
    ...
    label: 'Dashboards',
    starterPrompt: 'Create an RethraDesign prototype plugin for business systems, admin panels, or analytics dashboards.',
    test: byAnySlug(
      'dashboard',
      'admin-panel',
      'analytics',
  ...
  },
  {
    ...
    slug: 'app-prototypes',
    label: 'Apps',
    starterPrompt: 'Create an RethraDesign prototype plugin for multi-screen apps, onboarding, or task-productivity flows.',
    test: byAnySlug(
      'mobile',
      'app',
      'mobile-app',
  ...
  },
  {
    ...
    starterPrompt: 'Create an RethraDesign prototype plugin for landing pages, marketing sites, pricing pages, or campaign pages.',
    test: byAnySlug(
      'landing',
      'landing-page',
      'saas-landing',
  ...
  },
  {
    ...
    starterPrompt: 'Create an RethraDesign prototype plugin for developer tools, engineering workflows, docs, or code collaboration.',
    test: byAnySlug(
      'engineering',
      'docs',
      'documentation',
  ...
  },
  {
    ...
    slug: 'docs-reports',
    label: 'Docs / reports',
    starterPrompt: 'Create an RethraDesign prototype plugin for reports, documents, case studies, specs, invoices, or resumes.',
    test: byAnySlug(
      'report',
      'financial-report',
      'finance-report',
  ...
  },
  {
    ...
    slug: 'brand-design',
    label: 'Brand / design',
    starterPrompt: 'Create an RethraDesign prototype plugin for brand pages, visual exploration, design reviews, or mockups.',
    test: byAnySlug(
      'design',
      'design-review',
      'design-audit',
  ...
  ...DECK_SUBCATEGORIES,
  {
    ...
    starterPrompt: 'Create an RethraDesign image plugin for product UI mockups, game UI, product cards, or interface showcases.',
    test: byAnySlug(
      'app-web-design',
      'game-ui',
      'ui',
  ...
  },
  {
    ...
    slug: 'brand-visuals',
    label: 'Brand / logo',
    starterPrompt: 'Create an RethraDesign image plugin for logos, brand visuals, typography-led posters, or visual systems.',
  ...
  },
  {
    ...
    label: 'Storyboards',
    starterPrompt: 'Create an RethraDesign image plugin for storyboards, choreography breakdowns, pose references, or motion planning sheets.',
  ...
  },
  {
    ...
    starterPrompt: 'Create an RethraDesign image plugin for social posts, infographics, explainers, or content graphics.',
  ...
  },
  {
    ...
    starterPrompt: 'Create an RethraDesign image plugin for avatars, portraits, identity photos, or character headshots.',
  ...
  },
  {
    ...
    starterPrompt: 'Create an RethraDesign image plugin for illustrations, anime, fantasy scenes, 3D renders, or style-transfer prompts.',
    test: byAnySlug(
      'illustration',
      'anime',
      'fantasy',
  ...
  },
  {
    ...
    starterPrompt: 'Create an RethraDesign video plugin for motion graphics, VFX, title frames, animation, or logo/outro sequences.',
    test: byAnySlug(
      'motion-graphics',
      'vfx',
      'frame',
  ...
  },
  {
    ...
    starterPrompt: 'Create an RethraDesign video plugin for short-form social clips, vertical video, TikTok-style captions, or dance trends.',
  ...
  },
  {
    ...
    starterPrompt: 'Create an RethraDesign video plugin for product promos, advertising, brand sizzle reels, or marketing cuts.',
  ...
  },
  {
    ...
    starterPrompt: 'Create an RethraDesign video plugin for data explainers, animated charts, maps, diagrams, or flow walkthroughs.',
  ...
  },
  {
    ...
    starterPrompt: 'Create an RethraDesign video plugin for cinematic scenes, story sequences, anime/action shots, or fantasy clips.',
    test: byAnySlug(
      'cinematic',
      'fantasy',
      'action',
