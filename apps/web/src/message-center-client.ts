...
const LEGACY_WINDOW_KEY = 'rethra-design.message-center.anonymous-started-at.v1';
const MESSAGES_KEY = 'rethra-design.message-center.anonymous-messages.v1';
const READ_KEY = 'rethra-design.message-center.anonymous-read-ids.v1';
