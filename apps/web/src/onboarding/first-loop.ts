...
const ENTRY_KEY = (projectId: string) => `rethra-design:first-loop-entry:${projectId}`;
const STEPS_KEY = (projectId: string) => `rethra-design:first-loop-steps:${projectId}`;
const DONE_KEY = (projectId: string) => `rethra-design:first-loop-completed:${projectId}`;
