...
import { getRethraDesignHost } from '@rethra-design/host';
...
const LS_KEY = 'rethra-design:locale';
...
const LS_SOURCE_KEY = 'rethra-design:locale-source';
...
// through `getRethraDesignHost` rather than reading the bridge global by
...
function readDesktopHostOsLocale(): string | undefined {
  ...
  const host = getRethraDesignHost();
