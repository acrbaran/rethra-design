...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to Rethra Design Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrError.authMessage': 'Your Rethra Design Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your Rethra Design Cloud allowance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with Rethra Design Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the Rethra Design Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.title.signInRequired.amr': 'Rethra Design is not signed in',
  ...
  'chat.runError.title.runtimeConfig': "Rethra Design error",
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update Rethra Design to the latest version, which ships a compatible runtime.",
  ...
  'chat.runError.cliSessionRefusedMessage':
    "{agent} refused to start a session. The installed version is usually incompatible with Rethra Design — switch to a different version and retry.",
  ...
  'chat.runError.agentReplyIncompleteMessage': "The agent's reply came back without the marker Rethra Design needs to record this step, so the task couldn't move on. Nothing you sent was lost — this one is intermittent, and retrying usually goes through.",
  ...
  'settings.welcomeTitle': 'Welcome to Rethra Design',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. Rethra Design will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. Rethra Design reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingExecutionBody': 'Use the Rethra Design hosted service, connect a local coding agent, or bring your own model key.',
  ...
  'settings.onboardingCloudTitle': 'Sign in to Rethra Design',
  'settings.onboardingCloudBody': 'Sign in to start designing with cloud AI right away — no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to Rethra Design',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to Rethra Design Cloud to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Rethra Design daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Rethra Design.',
  ...
  'settings.amrAccountStatus': 'Rethra Design Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose Rethra Design as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the Rethra Design team',
  'settings.privacyConsentKicker': 'Help us improve Rethra Design',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how Rethra Design performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time Rethra Design starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but Rethra Design could not quit automatically.',
  ...
  'settings.mcpTitle': 'Connect Rethra Design to your coding agent',
  'settings.mcpHint': 'Use MCP to give supported agents access to your projects and design context.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Rethra Design is running, then reopen this panel.',
  'settings.mcpBuildDaemon': 'Build the daemon first.',
  'settings.mcpNodeMissing': 'Node binary is missing.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js is missing. Run `pnpm --filter @rethra-design/daemon build` and refresh.',
  ...
  'settings.mcpCapabilityDefault': 'Use the project and file currently open in Rethra Design as context.',
  'settings.mcpRunningNote': 'Keep Rethra Design running. Restart your coding agent after setup.',
  ...
  'entry.discordAriaWithOnline': 'Join the Rethra Design Discord - {online}',
  'entry.discordOnlineLabel': '{count} online',
  'entry.xAria': 'Follow @RethraDesignHQ for updates',
  ...
  'entry.followXLabel': 'Follow @RethraDesignHQ on X',
  'entry.followThreadsLabel': 'Follow Rethra Design on Threads',
  'entry.youtubeLabel': 'Rethra Design on YouTube',
  'entry.followInstagramLabel': 'Follow @rethradesign.ai on Instagram',
  'entry.followLinkedinLabel': 'Follow Rethra Design on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow Rethra Design on Xiaohongshu',
  ...
  "entry.cloudCalloutBody": "Sign in to use Rethra Design Cloud and collaborate in the cloud",
  "entry.cloudCalloutDismissAria": "Dismiss Rethra Design Cloud note",
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable Rethra Design plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit Rethra Design Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local Rethra Design project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. Rethra Design Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use Rethra Design workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Rethra Design and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to Rethra Design',
  'pluginCard.contributeTitle': 'Contribute plugin to Rethra Design with a pull request',
  'skillPluginCandidate.createForMe': 'Create plugin/template',
  'skillPluginCandidate.contributeToMain': 'Contribute to rethra-design',
  'skillPluginCandidate.repoDescription': 'This repo looks like it could work as a plugin.',
  'integrations.kicker': 'Integration',
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Rethra Design from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Rethra Design is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use Rethra Design everywhere',
  'useEverywhere.modalTitle': 'Use Rethra Design everywhere',
  'useEverywhere.modalSubtitle': 'Drop Rethra Design into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'Rethra Design works wherever your agent works',
  'useEverywhere.section.overview.intro': 'Rethra Design is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires Rethra Design as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Rethra Design at all.',
  ...
  'useEverywhere.section.overview.footer': 'The daemon writes to `./.od/` (project-local) by default. Set `OD_DATA_DIR=~/.rethra-design` to share data across projects.',
  'useEverywhere.section.cli.tab': 'CLI · od',
  'useEverywhere.section.cli.heading': 'Drive Rethra Design from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Rethra Design as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Rethra Design ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Rethra Design tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the Rethra Design app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  'useEverywhere.section.http.tab': 'HTTP API',
  'useEverywhere.section.http.heading': 'Same REST + SSE surface the web UI uses',
  'useEverywhere.section.http.intro': 'The local daemon serves an HTTP API at `http://127.0.0.1:7456` (port configurable). Every endpoint the web UI calls is also fair game for your scripts. Streaming endpoints (chat turns, project runs) emit Server-Sent Events with the contract types in `@rethra-design/contracts`.',
  ...
  'useEverywhere.section.http.footer': 'Pure TypeScript types for every request/response live in `@rethra-design/contracts` — import them in your script for full autocomplete without wiring a generator.',
  'useEverywhere.section.skills.tab': 'Skills & headless',
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Rethra Design running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Rethra Design extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside Rethra Design and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + Rethra Design extras)',
  ...
  'entry.githubStarAria': 'Star Rethra Design on GitHub',
  ...
  'newproj.locationDefault': 'Rethra Design projects',
  ...
  'avatar.amrConsole': 'Rethra Design Cloud',
  ...
  'socialShare.rethraDesignSection': 'Share Rethra Design',
  'socialShare.rethraDesignTitle': 'Rethra Design on GitHub',
  'socialShare.rethraDesignText': 'Rethra Design is a source-available workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with Rethra Design: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with Rethra Design: {title}\n{url}\nRethraDesign repo: {repo}',
  ...
  'brandEnrichment.body': "Rethra Design will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask Rethra Design to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want Rethra Design to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'chat.designToolbox.aria': 'Launch design toolbox',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Rethra Design is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying Rethra Design? Star us on GitHub.',
  'designFiles.usefulInfoTip8': 'Follow @RethraDesignHQ on X for the latest updates.',
  ...
  'designFiles.usefulInfoTip16': 'Follow @rethradesign.ai on Threads for behind-the-scenes updates.',
  'designFiles.usefulInfoTip17': 'Follow @rethradesign.ai on Instagram for design inspiration.',
  'designFiles.usefulInfoTip18': 'Subscribe to Rethra Design on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow Rethra Design on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow Rethra Design on Xiaohongshu for tips and inspiration.',
  ...
  'fileViewer.shareMenuPublishViaOd': 'QUICK SHARE · RETHRADESIGN',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'A share link needs a signed-in workspace. Sign in to Rethra Design Cloud, or use a deploy option to share this file.',
  ...
  'assistant.shareToRethraDesign': 'Share to Rethra Design',
  'assistant.shareToRethraDesignBusy': 'Preparing package…',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Rethra Design — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Rethra Design — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple Rethra Design project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions Rethra Design should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'updater.availableBody': 'Rethra Design {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'Rethra Design is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'Rethra Design could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. Rethra Design is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit Rethra Design',
  'updater.quitFailedBody': 'The installer is open, but Rethra Design could not quit. Quit Rethra Design before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. Rethra Design will close and open the installer.',
  'updater.readyVersion': 'Rethra Design {version} is ready. Rethra Design will close and open the installer.',
  'updater.reinstallLearnMore': 'Learn more',
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. Rethra Design will close and open the installer.',
  'updater.reinstallReadyVersion': 'Rethra Design {version} requires a full reinstall. Rethra Design will close and open the installer.',
  ...
  'whatsNew.updatedTitle': 'Rethra Design {version} is here',
  ...
  'dsManager.createBody': 'Teach Rethra Design your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions Rethra Design follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach Rethra Design your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'Rethra Design turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'From Aug 13–27, paid users can use DeepSeek V4 Pro and V4 Flash for free in Rethra Design. Large-scale abuse may pause campaign access.',
  'campaign.deepseekV4Flash.windowLabel': 'Aug 13–27',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'two weeks free',
  'campaign.deepseekV4Flash.boundary': 'Unlimited model quota and free generation counts in your plan apply only inside Rethra Design — not via MCP, CLI, API, or other surfaces. Final interpretation rests with Rethra Design. Some models may need to queue at peak hours.',
  ...
  'experienceSurvey.tag': "We'd love your feedback — help improve Rethra Design",
  'experienceSurvey.close': "Close",
  'experienceSurvey.recommendation': "How likely are you to recommend Rethra Design to a colleague or friend?",
  ...
  'chat.designSystemStatus.description': 'Rethra Design is using the setup sources to generate this project.',
  ...
  'labs.harnessHint': "Your next generation will use Rethra Design's latest strategy, with noticeably more polished results (beta)",
  'labs.harnessTooltip': "Switches to the agent harness Rethra Design built for design work. Output is noticeably better in layout, structure, and completeness.",
  ...
  'chat.pluginAction.contributionStarted': 'Rethra Design contribution task started for {path}.',
