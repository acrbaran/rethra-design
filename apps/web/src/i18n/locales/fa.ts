...
export const fa: Dict = {
  ...
  'chat.amrCard.switchBody': 'به سرویس رسمی مدل Rethra Design Cloud سوئیچ کنید — بدون نیاز به تنظیم کلید API. پس از ورود، اعطای دسترسی و شارژ، این اجرا به‌طور خودکار دوباره انجام می‌شود.',
  ...
  'chat.amrError.authMessage': 'حساب Rethra Design Cloud شما هنوز مجاز نشده است. آن را مجاز کنید تا این اجرا به‌طور خودکار دوباره انجام شود.',
  'chat.amrError.balanceMessage': 'موجودی Rethra Design Cloud شما تمام شده است. برای ادامه این اجرا شارژ کنید.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'آنچه Rethra Design Cloud به شما می‌دهد',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'شما از ایجنت Rethra Design Cloud استفاده می‌کنید — وارد شوید تا این وظیفه بلافاصله شروع شود.',
  ...
  'chat.runError.title.signInRequired.amr': 'به Rethra Design وارد نشده‌اید',
  ...
  'chat.runError.title.runtimeConfig': "خطای اجرای Rethra Design",
  ...
  'chat.runError.cpuUnsupportedMessage': "محیط اجرای این عامل به مجموعه دستورالعمل پردازنده (AVX2) نیاز دارد که این دستگاه فاقد آن است، بنابراین نمی‌تواند اجرا شود. Rethra Design را به آخرین نسخه که محیط اجرای سازگار دارد به‌روزرسانی کنید.",
  ...
  'chat.runError.cliSessionRefusedMessage':
    "{agent} از شروع جلسه خودداری کرد. معمولاً نسخهٔ نصب‌شده با Rethra Design سازگار نیست؛ به نسخهٔ دیگری تغییر دهید و دوباره تلاش کنید.",
  ...
  'chat.runError.agentReplyIncompleteMessage': "پاسخ عامل بدون نشانه‌ای که Rethra Design برای ثبت این مرحله لازم دارد برگشت؛ به همین دلیل کار نتوانست ادامه یابد. هیچ‌چیز از آنچه فرستادید از دست نرفته است؛ این مورد گاه‌به‌گاه پیش می‌آید و معمولاً تلاش دوباره کارساز است.",
  ...
  'settings.welcomeTitle': 'به Rethra Design خوش آمدید',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'شروع با یک شرح',
  'settings.onboardingCreateBody': 'سایت، اپلیکیشن، ارائه، تصویر یا ویدیویی را که می‌خواهید توصیف کنید. Rethra Design یک پروژه می‌سازد و کار را قابل ویرایش نگه می‌دارد.',
  ...
  'settings.onboardingMemoryCalloutBody': 'این پاسخ‌ها نمایهٔ حافظهٔ شما را شکل می‌دهند. Rethra Design در هر کار از آن استفاده می‌کند و همزمان با کار شما به یادگیری ادامه می‌دهد.',
  ...
  'settings.onboardingExecutionBody': 'از سرویس میزبانی‌شده Rethra Design استفاده کنید، یک عامل محلی را متصل کنید یا کلید مدل خود را بیاورید.',
  ...
  'settings.onboardingAmrCloudAuthorizeAction': 'مجوزدهی Rethra Design Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'مراحل بعدی با هوش مصنوعی اجرا می‌شوند — برای ادامه وارد Rethra Design Cloud شوید.',
  ...
  'settings.agentInstall.stepAuth': 'قبل از بازگشت به Rethra Design، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.amrAccountStatus': 'وضعیت حساب Rethra Design Cloud',
  ...
  'settings.amrLoginErrorCompact': 'ورود به Rethra Design Cloud ناموفق بود.',
  ...
  'settings.mcpServerHint': 'Rethra Design را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'settings.privacyHint': 'چه داده‌هایی با تیم Rethra Design به اشتراک گذاشته می‌شود',
  'settings.privacyConsentKicker': 'به ما در بهبود Rethra Design کمک کنید',
  'settings.privacyConsentLead': 'اشتراک‌گذاری داده‌های استفاده به ما کمک می‌کند عملکرد Rethra Design را در جریان‌های کاری واقعی بهتر بفهمیم تا بخش‌هایی را که بیشترین اثر را بر تجربه شما دارند بهبود دهیم.',
  ...
  'settings.updateQuitFailed': 'نصب‌کننده باز شد، اما Rethra Design نتوانست خودکار خارج شود.',
  ...
  'settings.mcpHint': 'به Agentهای کدنویسی (Cursor، Claude Code، VS Code…) اجازه دهید پروژه‌های Rethra Design شما را مستقیماً بخوانند.',
  'settings.mcpDaemonError': 'امکان دسترسی به daemon محلی برای تعیین مسیرهای نصب وجود نداشت ({error}). مطمئن شوید که Rethra Design در حال اجراست، سپس این پنل را دوباره باز کنید.',
  'settings.mcpBuildDaemon': 'ابتدا daemon را بسازید.',
  'settings.mcpNodeMissing': 'باینری Node یافت نشد.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js یافت نشد. دستور `pnpm --filter @rethra-design/daemon build` را اجرا کنید و صفحه را تازه‌سازی کنید.',
  ...
  'settings.mcpCapabilityDefault': 'به‌صورت پیش‌فرض از پروژه و فایلی که در Rethra Design باز کرده‌اید استفاده می‌کند، بنابراین می‌توانید بگویید «این را در اپ من بساز» بدون اینکه دوباره مشخص کنید کدام طراحی.',
  'settings.mcpRunningNote': 'برای موفقیت فراخوانی‌های ابزار MCP، Rethra Design باید در حال اجرا باشد. اگر Agent کدنویسی خود را پیش از باز کردن Rethra Design راه‌اندازی کرده‌اید، Agent را راه‌اندازی مجدد کنید تا بتواند به daemon زنده دسترسی پیدا کند.',
  ...
  'entry.xAria': 'برای دیدن قابلیت‌های تازه @RethraDesignHQ را دنبال کنید',
  ...
  'entry.followXLabel': 'دنبال کردن @RethraDesignHQ در X',
  'entry.followThreadsLabel': 'Follow Rethra Design on Threads',
  'entry.youtubeLabel': 'Rethra Design on YouTube',
  'entry.followInstagramLabel': 'دنبال کردن @rethradesign.ai در Instagram',
  'entry.followLinkedinLabel': 'دنبال کردن Rethra Design در LinkedIn',
  'entry.followXiaohongshuLabel': 'دنبال کردن Rethra Design در Xiaohongshu',
  ...
  "entry.cloudCalloutBody": "برای استفاده از Rethra Design Cloud و همکاری در فضای ابری وارد شوید",
  "entry.cloudCalloutDismissAria": "بستن یادداشت Rethra Design Cloud",
  ...
  'homeHero.chip.createPluginHint': 'یک افزونه قابل استفاده مجدد Rethra Design بسازید و آن را به افزونه‌های من اضافه کنید.',
  ...
  'handoff.amrWebsite': 'باز کردن وب‌سایت Rethra Design Cloud',
  ...
  'handoff.promptIntro': 'ادامه از این پوشه محلی پروژه Rethra Design:',
  ...
  'pluginsHome.subtitle': 'گردش‌کارهای آماده Rethra Design که همراه این runtime ارائه شده‌اند. یکی را برای بارگذاری یک پرامپت شروع انتخاب کنید، یا برای موارد بیشتر در رجیستری بگردید.',
  ...
  'pluginsHome.emptyCatalog': 'کاتالوگ خالی است. پلاگین‌های همراه با Rethra Design ارائه می‌شوند و باید به‌صورت خودکار اینجا نمایش داده شوند — اگر این مشکل ادامه داشت، daemon را مجدداً راه‌اندازی کنید.',
  ...
  'pluginCard.contributeAria': 'مشارکت {title} در Rethra Design',
  'pluginCard.contributeTitle': 'مشارکت افزونه در Rethra Design با یک PR',
  'skillPluginCandidate.createForMe': 'ساخت افزونه/قالب',
  'skillPluginCandidate.contributeToMain': 'مشارکت در rethra-design',
  ...
  'integrations.lede': 'سیستم‌های خارجی را متصل کنید، ابزارهای MCP را به حلقه Agent خود بیاورید و از Rethra Design در سایر IDEها، اسکریپت‌ها و خودکارسازی‌ها استفاده کنید.',
  ...
  'mcpClient.daemonError': 'دسترسی به daemon محلی ممکن نشد. مطمئن شوید Rethra Design در حال اجراست، سپس این پنل را دوباره باز کنید.',
  'mcpClient.saveFailed': 'ذخیره ناموفق بود. بررسی کنید که daemon در حال اجرا باشد و دوباره تلاش کنید.',
  'useEverywhere.modalAria': 'استفاده از Rethra Design در همه‌جا',
  'useEverywhere.modalTitle': 'استفاده از Rethra Design در همه‌جا',
  'useEverywhere.modalSubtitle': 'Rethra Design را در هر IDE، Agent یا اسکریپتی بگنجانید — CLI، HTTP، MCP و Skills. از «Copy guide for an agent» استفاده کنید و آن را در Claude Code، Codex، Cursor، openclaw یا hermes جای‌گذاری کنید تا همه‌چیز راه‌اندازی شود.',
  ...
  'useEverywhere.section.overview.heading': 'Rethra Design هر جا که Agent شما کار کند، کار می‌کند',
  'useEverywhere.section.overview.intro': 'Rethra Design چیزی فراتر از یک پنجره است — یک daemon محلیِ دارای دسترسی ویژه (`od`) به‌علاوه یک رجیستری از Skills + Design-Systems + Atoms است. به‌محض اینکه روی دستگاه شما در حال اجرا باشد، هر code agent (Claude Code، Codex، Cursor، OpenCode/openclaw، Hermes، یا اسکریپت خودتان) می‌تواند تولیدها را هدایت کند، پروژه‌ها را بررسی کند و از طریق چهار سطح قابل‌تعویض، آثار طراحی تولید کند.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` برای اسکریپت‌های headless، CI و اتوماسیون shell.',
  'useEverywhere.section.overview.bullet2': 'سرور MCP — Rethra Design را به‌عنوان یک سرور Model Context Protocol سیم‌کشی می‌کند تا هر Agent سازگار با MCP بتواند skillها را فهرست کند، سناریوها را اجرا کند و آثار را بخواند.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — بسته‌های آمادهٔ `SKILL.md` (سازگار با Claude) که هر Agent موجود در PATH شما می‌تواند بدون نیاز به Rethra Design اصلاً فراخوانی‌شان کند.',
  ...
  'useEverywhere.section.overview.footer': 'daemon به صورت پیش‌فرض در `./.od/` (محلی پروژه) می‌نویسد. برای اشتراک‌گذاری داده‌ها میان پروژه‌ها، `OD_DATA_DIR=~/.rethra-design` را تنظیم کنید.',
  'useEverywhere.section.cli.tab': 'CLI · od',
  'useEverywhere.section.cli.heading': 'کنترل Rethra Design از هر shell',
  ...
  'useEverywhere.section.mcp.heading': 'در معرض قرار دادن Rethra Design به‌عنوان یک سرور MCP برای هر Agent کدنویسی',
  'useEverywhere.section.mcp.intro': 'Rethra Design با یک سرور Model Context Protocol (`od mcp`) ارائه می‌شود که به هر کلاینت سازگار با MCP — Cursor، Claude Code، Antigravity، VS Code Copilot Chat، openclaw، hermes — اجازه می‌دهد ابزارهای Rethra Design را کشف کند (فهرست‌کردن skillها، رندر پیش‌نمایش‌ها، تولید رسانه، اجرای پلاگین‌ها) بدون نیاز به اجرای دستی در shell. این daemon برای هر کلاینت اصلی یک قطعهٔ نصب آمادهٔ جای‌گذاری را از طریق `GET /api/mcp/install-info` منتشر می‌کند.',
  ...
  'useEverywhere.section.mcp.footer': 'در اپلیکیشن Rethra Design، به Settings ← Integrations بروید تا یک دستور نصب مخصوص کلاینت (Cursor، Claude Code، Antigravity، VS Code) را کپی کنید، به‌جای ویرایش دستی JSON.',
  ...
  'useEverywhere.section.http.footer': 'تایپ‌های خالص TypeScript برای هر درخواست/پاسخ در `@rethra-design/contracts` قرار دارند — آن‌ها را در اسکریپت خود import کنید تا بدون سیم‌کشی یک generator، تکمیل خودکار کامل داشته باشید.',
  'useEverywhere.section.skills.tab': 'مهارت‌ها و حالت بدون رابط',
  'useEverywhere.section.skills.heading': 'Skillهای آمادهٔ استفاده برای هر Agent — حتی بدون اجرای Rethra Design',
  'useEverywhere.section.skills.intro': 'یک Skill دایرکتوری‌ای است با یک `SKILL.md` سازگار با Claude (فرانت‌متر YAML + بدنه). Rethra Design این فرمت را با namespace به نام `od:` گسترش می‌دهد (`mode`، `preview`، `design_system`، `inputs`، …) تا همان اثر هم درون Rethra Design و هم توسط یک Agent معمولی مانند Claude Code، Codex، openclaw یا hermes قابل‌استفاده باشد. کشف از یک زنجیرهٔ اولویت پیروی می‌کند تا پروژه‌ها بتوانند skillهای خود را بازنویسی کنند.',
  ...
  'useEverywhere.section.skills.snippet1': 'حداقل SKILL.md (front matter سازگار با Claude + افزوده‌های Rethra Design)',
  ...
  'entry.githubStarAria': 'به Rethra Design در GitHub ستاره بدهید',
  ...
  'newproj.locationDefault': 'پروژه‌های Rethra Design',
  ...
  'avatar.amrConsole': 'حساب Rethra Design Cloud',
  ...
  'socialShare.rethraDesignSection': 'اشتراک‌گذاری Rethra Design',
  'socialShare.rethraDesignTitle': 'Rethra Design در GitHub',
  'socialShare.rethraDesignText': 'Rethra Design یک فضای کاری با کد منبع در دسترس برای ساخت، ویرایش، استقرار و تحویل آرتیفکت‌های طراحی است.',
  ...
  'socialShare.projectText': 'ساخته‌شده با Rethra Design: {title}. آرتیفکت مستقرشده را ببینید و به مخزن ستاره بدهید: {repo}',
  'socialShare.projectCopyText': 'ساخته‌شده با Rethra Design: {title}\n{url}\nمخزن Rethra Design: {repo}',
  ...
  'brandEnrichment.body': "Rethra Design یک استخراج عمیق تر را در پس زمینه اجرا می کند، skills مناسب design system را خودکار اعمال می کند و همین سیستم را درجا به روز می کند. این کار ممکن است 10 تا 20 دقیقه طول بکشد؛ می توانید به کارتان ادامه دهید.",
  ...
  'chat.activeFilePlaceholder': 'از Rethra Design بخواهید {file} را تغییر دهد...',
  ...
  'chat.mode.design.solves': 'وقتی می خواهید Rethra Design فایل بسازد، workspace را به روز کند یا brief را به خروجی های چندرسانه ای قابل تحویل تبدیل کند استفاده کنید.',
  ...
  'preview.shareTextDefault': 'قالب Rethra Design: {title}',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید Rethra Design در حال اجراست و دوباره تلاش کنید.',
  ...
  'designFiles.usefulInfoTip7': 'از Rethra Design راضی هستید؟ در GitHub به ما ستاره بدهید.',
  'designFiles.usefulInfoTip8': 'برای آخرین خبرها @RethraDesignHQ را در X دنبال کنید.',
  ...
  'designFiles.usefulInfoTip16': 'برای دیدن پشت‌صحنه‌ها، @rethradesign.ai را در Threads دنبال کنید.',
  'designFiles.usefulInfoTip17': 'برای الهام در طراحی، @rethradesign.ai را در Instagram دنبال کنید.',
  'designFiles.usefulInfoTip18': 'برای آموزش‌ها و دموها، Rethra Design را در YouTube دنبال کنید.',
  'designFiles.usefulInfoTip19': 'برای اخبار محصول، Rethra Design را در LinkedIn دنبال کنید.',
  'designFiles.usefulInfoTip20': 'برای نکته‌ها و الهام، Rethra Design را در Xiaohongshu دنبال کنید.',
  ...
  'fileViewer.shareMenuPublishViaOd': 'اشتراک‌گذاری سریع · Rethra Design',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'ایجاد پیوند اشتراک‌گذاری نیازمند ورود به فضای کاری است. به Rethra Design Cloud وارد شوید یا این فایل را از طریق استقرار به اشتراک بگذارید.',
  ...
  'assistant.shareToRethraDesign': 'اشتراک‌گذاری در Rethra Design',
  'assistant.shareToRethraDesignBusy': 'در حال آماده‌سازی بسته…',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه Rethra Design — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه Rethra Design ارائه می‌شود — نیازی به دانلود نیست.',
  ...
  'settings.projectLocationsDescription': 'پایه‌های کاری اضافه کنید که می‌توانند چند پوشهٔ پروژهٔ Rethra Design را در خود داشته باشند. پروژه‌های جدید به‌صورت یک پوشه داخل پایهٔ انتخاب‌شده ذخیره می‌شوند.',
  ...
  'settings.customInstructionsHint': 'دستورالعمل‌های ثابتی که Rethra Design باید در هر گفت‌وگو دنبال کند. حقایق، ترجیحات و زمینهٔ پروژه را به‌عنوان حافظه ذخیره کنید.',
  ...
  'settings.memoryStarterProjectDesc': 'Rethra Design v0.5 — ویرایشگر طراحی مبتنی بر گفتگو',
  ...
  'updater.activeRunsTitle': 'Rethra Design هنوز در حال کار است',
  'updater.activeRunsBody': '{count} کار فعال هنوز در حال اجراست. راه‌اندازی مجدد اکنون آن‌ها را متوقف می‌کند.',
  'updater.activeRunsUnknownBody': 'Rethra Design نتوانست بررسی کند که آیا کاری در حال اجراست. راه‌اندازی مجدد ممکن است کار فعال را متوقف کند.',
  'updater.availableBody': 'Rethra Design {version} موجود است. پیش از باز شدن نصب‌کننده دانلود می‌شود.',
  ...
  'updater.installerOpenBody': 'نصب‌کننده باز است. Rethra Design در حال بسته شدن است تا بتوانید به‌روزرسانی را کامل کنید.',
  ...
  'updater.quitButton': 'بستن Rethra Design',
  'updater.quitFailedBody': 'نصب‌کننده باز است، اما Rethra Design بسته نشد. پیش از جایگزینی برنامه، Rethra Design را ببندید.',
  'updater.quitFailedTitle': 'امکان بستن نیست',
  'updater.quitting': 'در حال بستن...',
  'updater.ready': 'به‌روزرسانی آماده است',
  'updater.readyGeneric': 'نسخه جدید آماده است. Rethra Design بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.readyVersion': 'Rethra Design {version} آماده است. Rethra Design بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.reinstallLearnMore': 'اطلاعات بیشتر',
  'updater.reinstallReadyGeneric': 'این به‌روزرسانی به نصب مجدد کامل نیاز دارد. Rethra Design بسته می‌شود و نصب‌کننده باز خواهد شد.',
  'updater.reinstallReadyVersion': 'Rethra Design {version} به نصب مجدد کامل نیاز دارد. Rethra Design بسته می‌شود و نصب‌کننده باز خواهد شد.',
  ...
  'whatsNew.updatedTitle': 'Rethra Design {version} آمد',
  ...
  'dsManager.createBody': 'برند، محصول، کد، دارایی‌ها و مراجع طراحی خود را به Rethra Design بیاموزید.',
  ...
  'settings.customInstructionsDesc': 'دستورالعمل‌های ثابتی که Rethra Design در هر گفت‌وگو از آن‌ها پیروی می‌کند. این‌ها حافظه ذخیره‌شده نیستند؛ برای واقعیت‌ها، ترجیحات و بافت پروژه از حافظه استفاده کنید.',
  ...
  'onboarding.buildBody': 'Rethra Design برند شما را به یک سیستم طراحی قابل‌استفاده‌ی مجدد تبدیل می‌کند و هر چیزی را که می‌سازید هماهنگ و وفادار به برند نگه می‌دارد.',
  ...
  'ds.rethraDesignMd': 'باز کردن DESIGN.md',
  'ds.copyDesignMdModule': 'کپی بخش {module}',
  'ds.editDesignMdModule': 'ویرایش بخش {module}',
  'ds.rethraDesignMdModule': 'باز کردن بخش {module}',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'از ۱۳ تا ۲۷ اوت، کاربران پولی می‌توانند DeepSeek V4 Pro و V4 Flash را در Rethra Design رایگان استفاده کنند. سوءاستفاده گسترده ممکن است دسترسی کمپین را متوقف کند.',
  'campaign.deepseekV4Flash.windowLabel': '۱۳–۲۷ اوت',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'دو هفته رایگان',
  'campaign.deepseekV4Flash.boundary': 'سهمیه نامحدود مدل و تعداد تولید رایگان پلن فقط داخل Rethra Design اعمال می‌شود — نه از طریق MCP، CLI، API یا سطوح دیگر. تفسیر نهایی با Rethra Design است. برخی مدل‌ها ممکن است در ساعات شلوغی نیاز به نوبت داشته باشند.',
  ...
  'experienceSurvey.tag': "منتظر بازخورد شما هستیم — با هم Rethra Design را بهتر کنیم",
  'experienceSurvey.close': "بستن",
  'experienceSurvey.recommendation': "چقدر احتمال دارد Rethra Design را به همکار یا دوستتان پیشنهاد دهید؟",
  ...
  'chat.designSystemStatus.description': "Rethra Design در حال استفاده از منابع راه‌اندازی برای ساخت این پروژه است.",
  'labs.title': "آزمایشگاه Rethra Design",
  ...
  'labs.harnessHint': "با فعال‌سازی، تولید بعدی از جدیدترین استراتژی Rethra Design استفاده می‌کند و خروجی محسوساً پرداخته‌تر است (بتا)",
  'labs.harnessTooltip': "به agent harness ای که Rethra Design برای کارهای طراحی ساخته سوئیچ می‌کند. چیدمان، ساختار و کامل بودن خروجی به‌طور محسوس بهتر می‌شود.",
  ...
  'chat.pluginAction.contributionStarted': 'وظیفه مشارکت Rethra Design برای {path} آغاز شد.',
