...
export const zhTW: Dict = {
  ...
  'invite.landing.subtitle': "你受邀加入 Rethra Design 一起協作。",
  ...
  'invite.success.body': "正在開啟 Rethra Design，開始協作。",
  'invite.success.roleReceipt': "加入身分",
  'invite.success.enter': "進入工作空間",
  'invite.open.cta': "開啟 Rethra Design",
  'invite.open.opening': "正在開啟 Rethra Design…",
  'invite.open.retry': "已安裝？再次嘗試開啟",
  'invite.notInstalled.title': "沒有自動開啟？",
  'invite.notInstalled.body': "你的裝置可能尚未安裝 Rethra Design。安裝後重新開啟此連結即可完成加入。",
  'invite.notInstalled.download': "下載 Rethra Design",
  ...
  "chat.amrCard.switchBody":
    "可切換到 Rethra Design Cloud 官方模型服務，無需設定 API Key。完成登入、授權與儲值後，將自動重試目前任務。",
  ...
  "chat.amrError.authMessage":
    "Rethra Design Cloud 帳號尚未授權。完成授權後將自動重試目前任務。",
  "chat.amrError.balanceMessage":
    "Rethra Design Cloud 額度不足。儲值後即可繼續執行目前任務。",
  ...
  "chat.amrBalanceGate.benefitsTitle": "Rethra Design Cloud 為你提供",
  ...
  "chat.amrBalanceGate.signedOutTitle": "登入 Rethra Design Cloud，開始創作",
  "chat.amrBalanceGate.signedOutMessage": "目前使用的是 Rethra Design Cloud 智能體，登入後這個任務馬上就能開始。",
  ...
  "chat.runError.title.signInRequired.amr": "Rethra Design 尚未登入",
  ...
  "chat.runError.title.runtimeConfig": "Rethra Design 執行異常",
  ...
  "chat.runError.cpuUnsupportedMessage": "此智能體的執行時需要此裝置處理器不支援的指令集（AVX2），因此無法啟動。請將 Rethra Design 更新到最新版本，新版本附帶相容的執行時。",
  ...
  "chat.runError.cliSessionRefusedMessage":
    "{agent} 拒絕開始工作階段。通常是目前版本與 Rethra Design 不相容，換一個版本後重試。",
  "chat.runError.strategyTaskStateMismatchMessage": "該任務已被策略品質門攔下，本輪表單無法繼續提交。請重試請求或重新發起一次任務。",
  "chat.runError.agentReplyIncompleteMessage": "智慧體的回覆裡缺少 Rethra Design 記錄這一步所需的標記，任務因此沒能繼續。你提交的內容沒有遺失；這屬於偶發情況，重試一次通常就好了。",
  ...
  "chat.contextPrompt.referenceProject":
    "請把 Rethra Design 專案「{name}」作為參考上下文。它的本機路徑是：{path}。在設計或修改前，如有幫助請先搜尋並讀取這個目錄。",
  ...
  "settings.welcomeTitle": "歡迎使用 Rethra Design",
  "settings.welcomeSubtitle": "",
  "settings.onboardingCreateTitle": "從一句需求開始",
  "settings.onboardingCreateBody":
    "描述你想做的網站、應用、Deck、圖片或影片，Rethra Design 會建立專案，並保留可繼續編輯的產出。",
  ...
  "settings.onboardingMemoryCalloutBody":
    "這些回答會構成你的記憶檔案。Rethra Design 會在每個任務中重複使用它，並在你工作時持續學習。",
  ...
  "settings.onboardingExecutionBody":
    "使用 Rethra Design 託管服務、連接本機 Agent，或使用你自己的模型 Key。",
  ...
  "settings.onboardingAmrModelSourceLabel": "Rethra Design 託管",
  ...
  "settings.onboardingCloudTitle": "登入 Rethra Design",
  "settings.onboardingCloudBody":
    "登入後可直接用雲端 AI 開始設計，無需任何複雜設定。",
  "settings.onboardingCloudSignIn": "登入 Rethra Design 雲端",
  ...
  "settings.onboardingGateTooltipAmr":
    "後續流程由 AI 執行，請先登入 Rethra Design Cloud。",
  ...
  "settings.cloudCalloutTitle": "使用 Rethra Design Cloud",
  ...
  "settings.agentInstall.pathHint":
    "如果你透過 npm 或 Homebrew 安裝了 CLI，但仍顯示為未安裝，請確認該工具的 bin 目錄已加入 Rethra Design daemon 繼承的 PATH（在 macOS 上，Terminal 與 GUI 應用的 PATH 可能不同）。請參閱 QUICKSTART.md（「Local agent CLI and PATH」章節）。",
  "settings.agentInstall.stepOpenLinks":
    "在目標代理卡片上開啟「安裝」或「文件」連結。",
  "settings.agentInstall.stepAuth":
    "返回 Rethra Design 前，請先在對應 CLI 完成驗證（登入或新增 API 憑證）。",
  ...
  "settings.amrWalletRefreshTitle": "重新整理 Rethra Design Cloud 錢包餘額",
  ...
  "settings.amrAccountStatus": "Rethra Design Cloud 帳戶狀態",
  "settings.amrConsole": "管理",
  "settings.amrLoginErrorCompact": "Rethra Design Cloud 登入失敗。",
  ...
  "settings.dshSetupDescription": "Rethra Design 將透過這台電腦上的 dsh CLI 安裝連接元件。",
  "settings.dshSetupNote": "只安裝 Rethra Design 的 profile 元件。DeepSeek Harness 仍由你自行安裝和管理。",
  ...
  "settings.mcpServerHint":
    "將 Rethra Design 作為 MCP 伺服器暴露給你的編碼代理。",
  ...
  "settings.privacy": "隱私",
  "settings.privacyHint": "與 Rethra Design 團隊共享哪些資料",
  "settings.privacyConsentKicker": "協助我們改進 Rethra Design",
  "settings.privacyConsentLead":
    "分享使用資料後，我們能更了解 Rethra Design 在真實工作流裡的表現，並優先改進真正影響體驗的地方。",
  ...
  "settings.mcpTitle": "將 Rethra Design 連接至程式設計 agent",
  "settings.mcpHint": "透過 MCP，讓支援的 agent 存取您的專案與設計脈絡。",
  "settings.mcpDaemonError":
    "無法連線到本地守護程序以解析安裝路徑（{error}）。請確認 Rethra Design 正在執行，然後重新開啟此面板。",
  "settings.mcpBuildDaemon": "請先建置守護行程。",
  "settings.mcpNodeMissing": "缺少 Node 執行檔。",
  "settings.mcpBuildHint":
    "缺少 apps/daemon/dist/cli.js。請執行 `pnpm --filter @rethra-design/daemon build` 後重新整理。",
  ...
  "settings.mcpCapabilityDefault":
    "將目前在 Rethra Design 中開啟的專案與檔案作為脈絡。",
  "settings.mcpRunningNote": "請保持 Rethra Design 執行。設定完成後，重新啟動程式設計 agent。",
  ...
  "entry.discordAriaWithOnline": "加入 Rethra Design Discord - {online}",
  "entry.discordOnlineLabel": "{count} 在線",
  "entry.xAria": "追蹤 @RethraDesignHQ，掌握新功能",
  ...
  "entry.followXLabel": "在 X 上追蹤 @RethraDesignHQ",
  "entry.followThreadsLabel": "Follow Rethra Design on Threads",
  "entry.followInstagramLabel": "在 Instagram 上追蹤 @rethradesign.ai",
  "entry.followLinkedinLabel": "在 LinkedIn 上追蹤 Rethra Design",
  "entry.followXiaohongshuLabel": "在小紅書上追蹤 Rethra Design",
  ...
  "entry.cloudCalloutTitle": "Rethra Design Cloud 版",
  'entry.cloudRecovering': '帳號連線中斷，正在自動恢復…',
  'entry.authExpiredBody': '登入狀態已過期。登入後即可繼續使用 Rethra Design Cloud。',
  'home.createFailed': '啟動任務失敗，請再試一次。',
  'home.daemonRecovering': '本機服務連線中斷，正在自動恢復…',
  'home.bundledScenarioMissing': '內建場景「{scenarioId}」未安裝。請重新安裝 Rethra Design，以還原預設外掛。',
  "entry.cloudCalloutBody": "登入即可享受雲端協作",
  "entry.cloudCalloutDismissAria": "關閉 Rethra Design Cloud 版說明",
  ...
  "messageCenter.subtitle": "Rethra Design 更新、平台公告和權益提醒",
  ...
  "goPlanSunset.subtitle": "親愛的 Rethra Design 使用者：Rethra Design Go 上線後獲得許多關注與意見回饋。我們意識到目前 Rethra Design 在額度規則、產品體驗等方面仍有不足，對此深表歉意。",
  ...
  "homeHero.chip.createPluginHint":
    "編寫可重複使用的 Rethra Design 外掛並將其加入「我的外掛」。",
  ...
  "handoff.amrWebsite": "開啟 Rethra Design Cloud 官網",
  ...
  "handoff.promptIntro": "請基於這個 Rethra Design 專案的本機資料夾繼續實作：",
  ...
  "pluginsHome.subtitle":
    "隨附於此執行環境、可立即使用的 Rethra Design 工作流程。挑選一個以載入起始提示，或瀏覽登錄檔取得更多。",
  ...
  "pluginsHome.emptyCatalog":
    "目錄是空的。內建外掛隨 Rethra Design 一同提供，應會自動出現在此處 — 若問題持續發生，請嘗試重新啟動 daemon。",
  ...
  "pluginCard.contributeAria": "將 {title} 貢獻至 Rethra Design",
  "pluginCard.contributeTitle": "透過 pull request 將外掛貢獻至 Rethra Design",
  "skillPluginCandidate.createForMe": "建立外掛/範本",
  "skillPluginCandidate.contributeToMain": "貢獻到 rethra-design",
  "skillPluginCandidate.repoDescription": "這個倉庫看起來可以做成外掛。",
  "integrations.kicker": "整合",
  "integrations.lede":
    "連接外部系統，把 MCP 工具帶入智能體迴圈，並在其他 IDE、腳本與自動化流程中使用 Rethra Design。",
  ...
  "mcpClient.daemonError":
    "無法連線到本機 daemon。請確認 Rethra Design 正在執行，然後重新開啟此面板。",
  "mcpClient.saveFailed": "儲存失敗。請確認 daemon 正在執行後再試一次。",
  "useEverywhere.modalAria": "隨處使用 Rethra Design",
  "useEverywhere.modalTitle": "隨處使用 Rethra Design",
  "useEverywhere.modalSubtitle":
    "將 Rethra Design 接入任何 IDE、Agent 或指令碼 — CLI、HTTP、MCP 及 Skills。使用「複製 Agent 指南」並貼到 Claude Code、Codex、Cursor、openclaw 或 hermes 中，即可設定一切。",
  ...
  "useEverywhere.section.overview.heading":
    "你的 Agent 在哪裡運作，Rethra Design 就在哪裡運作",
  "useEverywhere.section.overview.intro":
    "Rethra Design 不只是一個視窗 — 它是一個本機特權 daemon（`od`），外加一個 Skills + Design-Systems + Atoms 登錄。一旦它在您的機器上執行，任何程式碼 Agent（Claude Code、Codex、Cursor、OpenCode/openclaw、Hermes、您自己的指令碼）都能透過四個可互換的介面來驅動產生作業、檢視專案並產出設計成品。",
  "useEverywhere.section.overview.bullet1":
    "CLI — 以 `od <command>` 用於無頭指令碼、CI 及 shell 自動化。",
  "useEverywhere.section.overview.bullet2":
    "MCP server — 將 Rethra Design 接成 Model Context Protocol 伺服器，讓任何支援 MCP 的 Agent 都能列出技能、執行情境並讀取成品。",
  ...
  "useEverywhere.section.overview.bullet4":
    "Skills — 隨插即用的 `SKILL.md` 套件（相容於 Claude），任何已在您 PATH 上的 Agent 完全無需 Rethra Design 即可調用。",
  ...
  "useEverywhere.section.overview.footer":
    "daemon 預設會寫入 `./.od/`（專案本機）。設定 `OD_DATA_DIR=~/.rethra-design` 即可在多個專案間共用資料。",
  "useEverywhere.section.cli.tab": "CLI · od",
  "useEverywhere.section.cli.heading": "從任何 shell 操作 Rethra Design",
  ...
  "useEverywhere.section.mcp.heading":
    "將 Rethra Design 以 MCP 伺服器形式開放給任何程式設計 Agent",
  "useEverywhere.section.mcp.intro":
    "Rethra Design 隨附一個 Model Context Protocol 伺服器（`od mcp`），讓任何支援 MCP 的用戶端 — Cursor、Claude Code、Antigravity、VS Code Copilot Chat、openclaw、hermes — 都能探索 Rethra Design 工具（列出技能、算繪預覽、產生媒體、執行外掛），而無需手動使用 shell。daemon 透過 `GET /api/mcp/install-info` 為每個主要用戶端發布可直接貼上的安裝程式碼片段。",
  ...
  "useEverywhere.section.mcp.footer":
    "在 Rethra Design 應用程式中，開啟「設定 → 整合」即可複製特定用戶端的安裝指令（Cursor、Claude Code、Antigravity、VS Code），而無需手動編輯 JSON。",
  ...
  "useEverywhere.section.http.intro":
    "本機 daemon 會在 `http://127.0.0.1:7456` 提供 HTTP API（連接埠可設定）。web UI 呼叫的每個端點，你的指令稿同樣可以使用。串流端點（聊天回合、專案執行）會發出 Server-Sent Events，其合約型別定義於 `@rethra-design/contracts`。",
  ...
  "useEverywhere.section.http.footer":
    "每個請求／回應的純 TypeScript 型別都位於 `@rethra-design/contracts` 中 — 在您的指令碼中匯入它們，即可享有完整的自動完成，而無需接上產生器。",
  "useEverywhere.section.skills.tab": "技能與無頭模式",
  "useEverywhere.section.skills.heading":
    "適用於任何 Agent 的隨插即用 Skills — 即使 Rethra Design 未在執行也行",
  "useEverywhere.section.skills.intro":
    "Skill 是一個包含相容於 Claude 的 `SKILL.md`（YAML 前置資料 + 內文）的目錄。Rethra Design 以 `od:` 命名空間（`mode`、`preview`、`design_system`、`inputs`、…）擴充此格式，因此同一個成品既能在 Rethra Design 內使用，也能被像 Claude Code、Codex、openclaw 或 hermes 這類原生 Agent 使用。探索作業遵循一條優先順序鏈，因此專案可覆寫自己的技能。",
  ...
  "useEverywhere.section.skills.snippet1":
    "最精簡的 SKILL.md（Claude 相容的前置資料 + Rethra Design 額外設定）",
  ...
  "entry.githubStarAria": "在 GitHub 為 Rethra Design 點亮 Star",
  ...
  "newproj.locationDefault": "Rethra Design 專案",
  ...
  "avatar.amrConsole": "Rethra Design Cloud 帳戶",
  ...
  "socialShare.rethraDesignSection": "分享 Rethra Design",
  "socialShare.rethraDesignTitle": "GitHub 上的 Rethra Design",
  "socialShare.rethraDesignText":
    "Rethra Design 是原始碼可用的設計智慧工作區，可以生成、編輯、部署並交付設計產物。",
  ...
  "socialShare.projectText":
    "我用 Rethra Design 做了 {title}。查看已部署產物，也推薦收藏倉庫：{repo}",
  "socialShare.projectCopyText":
    "我用 Rethra Design 做了 {title}\n{url}\nRethraDesign 倉庫：{repo}",
  ...
  "chat.brandBrowserAssistDesktopOnly":
    "瀏覽器輔助需要桌面應用，Rethra Design 才能讀取即時瀏覽器頁面。",
  ...
  "chat.brandBrowserAssistMessage":
    "Rethra Design 需要瀏覽器輔助才能完成這次品牌擷取。請先在 Browser 分頁清除頁面攔截，然後在下方確認。",
  "brandEnrichment.title": "AI 優化",
  "brandEnrichment.body":
    "Rethra Design 會在背景執行更深度的抽取，自動套用合適的設計系統 skills，並就地更新這個系統。通常需要 10-20 分鐘，你可以繼續做其他事。",
  ...
  "chat.activeFilePlaceholder": "讓 Rethra Design 修改 {file}...",
  ...
  "chat.mode.design.solves":
    "當你希望 Rethra Design 產生檔案、更新 workspace，或把需求變成多模態可交付結果時使用。",
  ...
  "designBrowser.reference.kicker": "Rethra Design 浏览器",
  ...
  "preview.shareTextDefault": "Rethra Design 模板：{title}",
  ...
  "preview.errorBody":
    "範例 HTML 載入失敗。請確認 Rethra Design 正在執行後重試。",
  "preview.retry": "重試",
  ...
  "designFiles.documentTemplate.goalBody":
    "說明希望 Rethra Design 基於這份文件生成、修改或判斷什麼。",
  ...
  "designFiles.documentTemplate.capabilityAgent":
    "Rethra Design agent 可以讀取、編輯這份檔案，並把它作為專案上下文。",
  ...
  "designFiles.documentTemplate.nextBody":
    "檢查並編輯這份文件，然後讓 Rethra Design 基於它生成、修改或執行操作。",
  ...
  "designFiles.usefulInfoTip8":
    "在 X 上關注 @RethraDesignHQ，第一時間了解新功能。",
  ...
  "designFiles.usefulInfoTip16":
    "在 Threads 上追蹤 @rethradesign.ai，看團隊幕後動態。",
  "designFiles.usefulInfoTip17":
    "在 Instagram 上追蹤 @rethradesign.ai，獲取設計靈感。",
  "designFiles.usefulInfoTip18":
    "在 YouTube 上訂閱 Rethra Design，觀看教學和示範。",
  "designFiles.usefulInfoTip19":
    "在 LinkedIn 上追蹤 Rethra Design，了解產品動態。",
  "designFiles.usefulInfoTip20":
    "在小紅書上追蹤 Rethra Design，獲取技巧和靈感。",
  ...
  "fileViewer.shareMenuPublishViaOd": "快速分享（Rethra Design 託管）",
  ...
  "fileViewer.publishFileRequiresWorkspace": "產生分享連結需要登入工作區。請登入 Rethra Design Cloud，或改用「部署」分享此檔案。",
  ...
  "assistant.shareToRethraDesign": "分享到 Rethra Design",
  "assistant.shareToRethraDesignBusy": "正在準備投稿…",
  ...
  "pet.navHint": "領養與自訂",
  "pet.tabBuiltIn": "內建",
  "pet.tabBuiltInHint": "Rethra Design 內建的精選寵物 — 一鍵領養。",
  "pet.builtInEmpty":
  ...
  "pet.codexBundled": "內建",
  "pet.codexBundledTitle": "Rethra Design 內建寵物，無需下載。",
  ...
  "settings.projectLocationsDescription":
    "新增可包含多個 Rethra Design 專案資料夾的工作基目錄。新專案會儲存為所選基目錄中的一個資料夾。",
  ...
  "settings.customInstructionsHint":
    "Rethra Design 在每次聊天中都應遵循的固定指示。將事實、偏好與專案脈絡儲存為記憶。",
  ...
  "artifact.odCardBrandAssistBody":
    "在瀏覽器中開啟品牌網站，讓 Rethra Design 繼續擷取此設計體系。",
  ...
  "updater.activeRunsTitle": "Rethra Design 仍在執行任務",
  "updater.activeRunsBody": "仍有 {count} 個任務正在執行。現在重新啟動會中斷這些任務。",
  "updater.activeRunsUnknownBody": "Rethra Design 無法確認是否仍有任務執行。現在重新啟動可能會中斷進行中的工作。",
  "updater.availableBody":
    "Rethra Design {version} 可用。下載完成後即可開啟安裝器。",
  ...
  "updater.installerOpenBody":
    "安裝器已開啟。Rethra Design 正在結束，以便你完成更新。",
  ...
  "updater.payloadReadyGeneric":
    "A new Rethra Design update is ready. Rethra Design will close and restart automatically.",
  "updater.payloadReadyVersion":
    "Rethra Design {version} is ready. Rethra Design will close and restart automatically.",
  "updater.quitButton": "結束 Rethra Design",
  "updater.quitFailedBody":
    "安裝器已開啟，但 Rethra Design 無法結束。替換應用程式前請先結束 Rethra Design。",
  "updater.quitFailedTitle": "無法結束",
  "updater.quitting": "正在結束…",
  "updater.ready": "更新已就緒",
  "updater.readyGeneric": "新版本已就緒。Rethra Design 會關閉並開啟安裝器。",
  "updater.readyVersion":
    "Rethra Design {version} 已就緒。Rethra Design 會關閉並開啟安裝器。",
  "updater.upToDate": "您已經是最新版本啦",
  "updater.viewVersionFeatures": "查看新版本特色",
  "updater.manualDownload": "手動下載",
  "updater.reinstallLearnMore": "了解詳情",
  "updater.reinstallReadyGeneric": "此更新需要完整重新安裝。Rethra Design 將關閉並開啟安裝程式。",
  "updater.reinstallReadyVersion": "Rethra Design {version} 需要完整重新安裝。Rethra Design 將關閉並開啟安裝程式。",
  "updater.restartAnyway": "仍然重新啟動",

  "whatsNew.updatedTitle": "Rethra Design {version} 已更新",
  "whatsNew.cta": "查看更新說明",
  ...
  'settings.updateQuitFailed': '安裝程式已開啟，但 Rethra Design 未能自動結束。',
  ...
  "dsManager.createBody":
    "把你的品牌、產品、程式碼、素材與設計參考教給 Rethra Design。",
  ...
  "settings.customInstructionsDesc":
    "Rethra Design 在每次對話中都會遵循的固定指令。它們不是儲存的記憶；事實、偏好與專案脈絡請使用「記憶」。",
  ...
  "brand.librarySubtitle":
    "把你的品牌套件教給 Rethra Design——從網站擷取一個品牌套件，然後在任意對話中套用它。",
  ...
  "onboarding.buildBody":
    "Rethra Design 將你的品牌沉澱為可重用的設計系統,讓你之後打造的一切都保持品牌一致。",
  ...
  "dsCreate.sourceSectionBody":
    "從 GitHub repo、網站、DESIGN.md 或能體現風格的檔案開始。Rethra Design 會先快速建立一套可用系統，之後 AI 可在專案中繼續細化。",
  ...
  "ds.extractionRunningBody": "Rethra Design 正在就地更新此體系。",
  ...
  "ds.sectionRunningReadingContext":
    "Rethra Design 正在讀取 {title} 的段落上下文。",
  ...
  "ds.repoConnectBannerBody":
    "連接 GitHub 後，Rethra Design 可以讀取你的儲存庫，並把顏色、字體和元件擷取到此設計體系中。",
  ...
  'library.getClipper': '取得 Rethra Design 網頁剪藏擴充功能',
  ...
  'library.emptyHintBefore': '用 Rethra Design 網頁剪藏擴充功能從任意網頁收藏，執行',
  ...
  'library.rethraDesignSystem': '開啟設計系統',
  ...
  'mcp.checking': '檢查中…',
  'mcp.clickConnectHint': '點擊「連線」，透過服務商的 OAuth 流程授予 Rethra Design 存取權限。',
  ...
  'mcp.noManagedOAuthSaveDirect': '儲存此伺服器後，Rethra Design 會直接使用它。',
  'mcp.noManagedOAuthUseAsConfigured': 'Rethra Design 會依你的設定使用此伺服器。如果伺服器需要 token，請在下方新增標頭。',
  ...
  'mcp.starting': '啟動中…',
  'mcp.toGrantOAuthAccess': '透過服務商的 OAuth 流程授予 Rethra Design 存取權限。',
  ...
  'memory.extractionSourceConnector': '已讀取已連接的應用程式，但 Rethra Design 無法將這些上下文轉化為記憶。',
  'memory.extractionSourceChat': 'Rethra Design 無法為這次對話執行記憶擷取。',
  ...
  'memory.noSuggestionsFound': '未找到記憶建議。Rethra Design 暫時無法從所選應用程式中讀取到有用的內容。',
  ...
  'memory.chooseSourcesHint': '請先選擇已連接的應用程式。Rethra Design 只會掃描你選取的應用程式。',
  ...
  'dsCreate.confirmTitle': 'Rethra Design 將擷取你的設計系統。',
  ...
  'dsCreate.githubMethodOdAccount': 'Rethra Design 帳號',
  'dsCreate.githubMethodOdAccountDesc': '由 Rethra Design 管理的原生 GitHub 登入；此版本尚未使用 OD 託管的 GitHub 權杖。',
  ...
  'dsFlow.activityRunningTitle': 'Rethra Design 正在更新此設計系統',
  ...
  'dsFlow.jobRebuildingTokens': 'Rethra Design 正在重建 token',
  'dsFlow.jobRevising': 'Rethra Design 正在修訂',
  'dsFlow.jobStillWorking': 'Rethra Design 仍在處理中',
  ...
  'dsFlow.pickLocalAgentFirst': '請先選擇一個本機代理，然後讓 Rethra Design 更新這個設計系統。',
  'dsFlow.previewPages': '預覽頁面',
  'dsFlow.proposedChanges': '建議的變更',
  'dsFlow.publishCardReady': 'Rethra Design 已可供審閱。請對目前的成果給出回饋，確認它對後續專案有用後再發布。',
  'dsFlow.publishCardRevision': 'Rethra Design 正在套用你的回饋。在準備更新草稿期間，你可以繼續審閱。',
  'dsFlow.publishCardTokenRebuild': 'Rethra Design 正在準備一份供審閱的 token 契約重建。在你接受之前，目前生效的契約保持不變。',
  'dsFlow.publishCardWorking': 'Rethra Design 仍在處理中，但你已經可以對目前的成果給出回饋。',
  ...
  'pluginDetail.officialBadge': 'Rethra Design 官方',
  ...
  'campaign.deepseekV4Flash.boundary': '方案內的無限制模型額度與免費生成次數，僅可透過 Rethra Design 使用；無法在 MCP/CLI/API 及其他場景使用。解釋權歸官方所有。部分模型尖峰時段需要排隊。',
  ...
  'experienceSurvey.tag': "期待您的回饋，與我們一起完善 Rethra Design",
  'experienceSurvey.close': "關閉",
  'experienceSurvey.recommendation': "你有多大可能把 Rethra Design 推薦給同事或朋友？",
  ...
  'chat.designSystemStatus.description': "Rethra Design 正在使用設定的來源生成此專案。",
  'labs.title': "Rethra Design 實驗室",
  ...
  'labs.harnessHint': "開啟後，下次生成將使用 Rethra Design 最新生成策略，生成效果更精緻（內測中）",
  'labs.harnessTooltip': "開啟後改用 Rethra Design 為設計場景打造的 agent harness，產物在版面、結構與完成度上會明顯更好。",
  ...
  'chat.pluginAction.contributionStarted': '已為 {path} 啟動 Rethra Design 貢獻任務。',
