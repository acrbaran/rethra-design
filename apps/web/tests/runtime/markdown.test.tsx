...
describe('renderMarkdown', () => {
  ...
  it('renders angle-wrapped destinations that contain spaces', () => {
    const out = html(
      '打开 [index.html](</Users/me/Library/Application Support/Rethra Design/project/index.html>)',
    );

    expect(out).toContain('<a class="md-link"');
    expect(out).toContain('href="/Users/me/Library/Application Support/Rethra Design/project/index.html"');
