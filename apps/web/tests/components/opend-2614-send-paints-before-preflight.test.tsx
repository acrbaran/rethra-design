 ...
 * RethraDesign Cloud(AMR)的预检 `checkAmrBalanceGate`。它排在
...
/** AMR on a daemon runtime — 报告里的那套配置(Agent 为 RethraDesign)。 */
...
describe('OPEND-2614 发送后先上屏,再等预检', () => {
   ...
   */
  it('夹具自检:AMR 这一发确实要过 RethraDesign Cloud 预检', async () => {
    renderProjectView();
