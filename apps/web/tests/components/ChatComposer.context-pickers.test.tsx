...
import type { AppliedPluginSnapshot, ProjectMetadata } from '@rethra-design/contracts';
...
describe('ChatComposer context pickers', () => {
  ...
  it('stages multiple referenced projects and links all resolved dirs together', async () => {
    ...
    referenceProjectDetails = {
      ...
      'reference-b': {
        project: referenceB,
        resolvedDir: '/tmp/rethra-design/reference-b',
      },
    };
    const onProjectMetadataChange = vi.fn();
    renderComposer({
    ...
    expect(projectPatchBodies()[0]?.metadata?.linkedDirs).toEqual([
      '/Users/me/work-dir',
      '/tmp/rethra-design/reference-a',
      '/tmp/rethra-design/reference-b',
    ]);
    await waitFor(() => {
