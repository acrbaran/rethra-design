...
import type { WorkspaceContextItem } from '@rethra-design/contracts';
...
describe('ContextChipHoverCard', () => {
  ...
  it('reveals the type and primary path on hover, then hides on leave', () => {
    render(
      <ContextChipHoverCard data-testid="chip" typeLabel="Referenced project" detail="/tmp/rethra-design/site">
        <span>My Project</span>
      </ContextChipHoverCard>,
    );
    ...
    expect(info.textContent).toContain('/tmp/rethra-design/site');
