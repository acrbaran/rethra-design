...
// summary turn freeform-recommended `od plugin publish --to rethra-design`
...
describe('PLUGIN_AUTHORING_PROMPT_TEMPLATE', () => {
  ...
  it('still asks the agent to scaffold generated-plugin with SKILL.md + manifest', () => {
    ...
    expect(PLUGIN_AUTHORING_PROMPT_TEMPLATE).toContain('rethra-design.json');
  ...
  it('forbids placeholder plugin.repo owners in generated manifests', () => {
    ...
    expect(PLUGIN_AUTHORING_PROMPT_TEMPLATE).toContain('rethra-design-user');
  ...
  it('bans freeform publish / repo CLI suggestions in the summary turn', () => {
    ...
    // `od plugin publish --to rethra-design`, `gh repo create
    ...
    expect(PLUGIN_AUTHORING_PROMPT_TEMPLATE).toContain('od plugin publish --to rethra-design');
  ...
  it('points the user at the plugin-folder card buttons instead', () => {
    ...
    expect(PLUGIN_AUTHORING_PROMPT_TEMPLATE).toContain('RethraDesign PR');
    expect(PLUGIN_AUTHORING_PROMPT_TEMPLATE).toMatch(
  ...
  it('warns against assuming standalone jq is installed', () => {
    ...
    expect(PLUGIN_AUTHORING_PROMPT_TEMPLATE).toMatch(/cat .*rethra-design\.json/);
