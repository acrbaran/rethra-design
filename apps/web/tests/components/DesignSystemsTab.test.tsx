...
import type { DesignSystemSummary } from '@rethra-design/contracts';
...
describe('DesignSystemsTab surface filtering', () => {
  it('scopes surface pill counts to the selected style category', () => {
    // Regression: acrbaran/rethra-design#2062 — surface chips kept showing the
  ...
  it('keeps the style category when a surface chip refines within it', () => {
    // Regression: acrbaran/rethra-design#2062 — clicking a surface chip reset
