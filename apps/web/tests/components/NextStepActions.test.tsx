...
function renderActions(
  ...
  const ui = (
    <NextStepActions
      ...
      onShareToRethraDesign={handlers.onShareToRethraDesign}
      skills={[
...
describe('NextStepActions', () => {
  ...
  it('cascades into Share / Download / Contribute and routes each action', () => {
    ...
    expect(h.onShareToRethraDesign).toHaveBeenCalledTimes(1);
  });
  ...
  it('hides the More row when nothing behind it is wired', () => {
    renderToolbox({
      ...
      onShareToRethraDesign: undefined,
