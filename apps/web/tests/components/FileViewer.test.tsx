...
describe('applyInspectOverridesToSource', () => {
  ...
  // Regression for acrbaran/rethra-design#362: if a source file has more than
  ...
  // Regression for acrbaran/rethra-design#362: the splicer must be HTML-aware
  ...
  // Regression for acrbaran/rethra-design#362: the splicer must look at real
...
describe('serializeInspectOverrides', () => {
  ...
  // Regression for acrbaran/rethra-design#362: standard deck slides ship as
...
// Regression for acrbaran/rethra-design#362: the host owns the inspect override
...
describe('parseInspectOverridesFromSource', () => {
  ...
  // Regression for acrbaran/rethra-design#362: hydration must require an
