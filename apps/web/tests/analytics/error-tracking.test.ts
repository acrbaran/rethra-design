...
describe('error-tracking', () => {
  ...
  it('scrubs absolute filesystem paths from stack frames before dispatch', () => {
    ...
    error.stack = [
      'Error: scrub-target',
      '    at handleClick (file:///Applications/Rethra Design.app/Contents/Resources/apps/web/src/FileViewer.tsx:147:23)',
    ...
    for (const frame of frames!) {
      ...
      if (typeof filename === 'string') {
        ...
        expect(filename).not.toContain('Applications/Rethra Design.app');
  ...
  it('drops packaged fetch noise from file:// app-bundle stack frames', () => {
    ...
    bundled.stack = [
      'TypeError: Failed to fetch',
      '    at fetchProjects (file:///Applications/Rethra Design.app/Contents/Resources/apps/web/src/state/projects.ts:88:14)',
    ].join('\n');
    ...
    beta.stack = [
      'TypeError: Failed to fetch',
      '    at fetchProjects (file:///Applications/Rethra Design Beta.app/Contents/Resources/apps/web/src/state/projects.ts:88:14)',
    ].join('\n');
