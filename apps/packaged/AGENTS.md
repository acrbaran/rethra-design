...
- Consume `@rethra-design/sidecar-proto`, `@rethra-design/sidecar`, and `@rethra-design/platform` primitives; do not hand-build stamp flags or process matching logic.
