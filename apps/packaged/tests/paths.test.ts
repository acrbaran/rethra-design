...
function fakeConfig(): PackagedConfig {
  return {
    ...
    namespaceBaseRoot: join("C:", "Users", "Fred", "AppData", "Roaming", "Rethra Design", "namespaces"),
    nodeCommand: null,
    posthogHost: null,
    posthogKey: null,
    resourceRoot: join("C:", "Program Files", "Rethra Design", "resources", "rethra-design"),
...
describe("resolvePackagedNamespacePaths", () => {
  ...
  it("rejects namespace overrides that would escape the namespace base root", () => {
    const config: PackagedConfig = {
      ...
      daemonSidecarEntry: null,
      namespace: "release",
      namespaceBaseRoot: "/tmp/rethra-design-packaged/namespaces",
      nodeCommand: null,
      resourceRoot: "/tmp/rethra-design-packaged/resources",
      telemetryRelayUrl: null,
      updateMetadataUrl: null,
      posthogKey: null,
      posthogHost: null,
