...
// `rethradesign://workspace/invite/continue?...&nonce=...` to wake this client. We
...
//
// The same scheme also carries `rethradesign://workspace/open` — the cloud
...
/**
 * Register the `rethradesign://` scheme and wire the OS deeplink events to
