...
entry. Rethra Design resolves that entry by looking for a root `index.html`,
...
bundled handset shell, never a hand-drawn approximation of one. Rethra Design
...
Rethra Design stages `.od-frames/layout.css` beside the handset shells and
