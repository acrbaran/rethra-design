...
Rethra Design's real entry point, with no overflow or cropping.
...
- PPTX, PDF, and other formats are produced by Rethra Design's product-side
...
This boundary is an Rethra Design product runtime boundary, not a default
...
- The output is a genuinely usable, still-editable single-file HTML; never
  describe a PPTX or PDF that Rethra Design's engineering has not yet produced
  as completed.
