...
When Rethra Design supplies a validated V2 binding, load the assets in this order:
...
are staged by Rethra Design into the project directory (`.od-frames/`) for the
...
runtime facts exist unless Rethra Design supplied them.
