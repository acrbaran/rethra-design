...
rethra-design-landing skill. Several common image-model defaults will
...
See `design-templates/rethra-design-landing/assets/imagegen-prompts.md` for the
...
- Always include the metadata strip, the side rails, the Roman
  section rules, and a footer with a giant `Rethra Design.` (or brand)
