...
description: Publish a local Rethra Design plugin to a new public GitHub repository using gh CLI.
triggers:
  - publish plugin
  - github repo
  - open source plugin
...
2. Inspect `rethra-design.json`, `SKILL.md`, and any compatibility metadata in the copied folder.
