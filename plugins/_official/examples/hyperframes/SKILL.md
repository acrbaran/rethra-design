...
## Rethra Design integration (load-bearing for this surface)

When this skill runs inside Rethra Design (i.e. `$OD_PROJECT_DIR` is set), the
...
do NOT write the composition HTML from scratch. Use Rethra Design's
...
#    already registered). Rethra Design writes these files itself; it does
