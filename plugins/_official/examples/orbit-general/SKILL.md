...
| Use placeholder names like "Service A / Project X" | Infer plausible real names from the connector type — GitHub → `acrbaran/rethra-design`, Sentry → `frontend-prod`, Linear → `ENG / DES` cycle 24, Stripe → `Pro plan / Acme Co.` |
