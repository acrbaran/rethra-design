...
The Rethra Design skill bundle (`SKILL.md`, `example.html`, `assets/template.html`,
and references in this folder) is contributed under Rethra Design's repository
