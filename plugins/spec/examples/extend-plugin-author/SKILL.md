...
description: Use this plugin when the user wants to create, improve, validate, publish, or submit an Rethra Design plugin using the plugin spec, examples, and PR workflow.
license: MIT
metadata:
...
3. Scaffold a plugin folder with `SKILL.md`, `rethra-design.json`, `README.md`, and evals when useful.
