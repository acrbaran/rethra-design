...
description: Use this plugin when the user has an existing Rethra Design artifact and wants targeted critique, patching, brand tightening, responsive fixes, or quality improvement without starting over.
license: MIT
metadata:
