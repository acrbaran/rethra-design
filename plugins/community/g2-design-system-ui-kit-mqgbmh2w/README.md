...
- Generate dark G2 HUD-style prototypes inside Rethra Design.
...
- `rethra-design.json` - Plugin manifest.
...
- Every path named in `SKILL.md` and `rethra-design.json` exists.
