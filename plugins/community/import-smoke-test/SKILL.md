...
description: A portable community plugin for validating Rethra Design plugin import flows.
---

# Community Import Smoke Test

Use this plugin when validating that Rethra Design can import community plugins
